...
trait Matchers extends Assertions with Tolerance with ShouldVerb with MatcherWords with Explicitly { matchers =>
  ...
  final class HavePropertyMatcherGenerator(symbol: Symbol, prettifer: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * book should have (convertSymbolToHavePropertyMatcherGenerator(<span class="stQuotedString">'title</span>).apply(<span class="stQuotedString">"A Tale of Two Cities"</span>))
     * </pre>
     */
  ...
  class ResultOfBeWordForAny[T](left: T, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * <span class="stLiteral">1</span> should be a positiveNumber
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * <span class="stLiteral">1</span> should be an oddNumber
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * result should be a [<span class="stType">String</span>]
     *                  ^
     * </pre>
    ...
    */
     ...
     *
     * <pre class="stHighlighted">
     * fileMock should be a (<span class="stQuotedString">'file</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * fruit should be an (<span class="stQuotedString">'orange</span>)
     *                 ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * fraction should be definedAt (<span class="stLiteral">6</span>)
     *                    ^
     * </pre>
     */
  ...
  final class RegexWord {
     ...
     *
     * <pre class="stHighlighted">
     * <span class="stQuotedString">"eight"</span> should not fullyMatch regex (<span class="stQuotedString">"""(-)?(\d+)(\.\d*)?"""</span>)
     *                                     ^
     * </pre>
     */
  ...
  final class ResultOfIncludeWordForString(left: String, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * string should include regex (<span class="stQuotedString">"world"</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * string should include regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * string should include regex (<span class="stQuotedString">"wo.ld"</span>.r)
     *                       ^
     * </pre>
     */
  ...
  final class ResultOfStartWithWordForString(left: String, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * string should startWith regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                         ^
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): Assertion = {
     ...
     *
     * <pre class="stHighlighted">
     * string should startWith regex (<span class="stQuotedString">"Hel*o"</span>.r)
     *                         ^
     * </pre>
     */
    def regex(rightRegex: Regex): Assertion = {
  ...
  final class ResultOfEndWithWordForString(left: String, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * string should endWith regex (<span class="stQuotedString">"wor.d"</span>)
     *                       ^
     * </pre>
     */
    def regex(rightRegexString: String): Assertion = regex(rightRegexString.r)
     ...
     *
     * <pre class="stHighlighted">
     * string should endWith regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                       ^
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): Assertion = {
     ...
     *
     * <pre class="stHighlighted">
     * string should endWith regex (<span class="stQuotedString">"wor.d"</span>.r)
     *                       ^
     * </pre>
     */
    def regex(rightRegex: Regex): Assertion = {
  ...
  final class ResultOfFullyMatchWordForString(left: String, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * string should fullMatch regex (<span class="stQuotedString">"Hel*o world"</span>)
     *                         ^
     * </pre>
     */
    def regex(rightRegexString: String): Assertion = regex(rightRegexString.r)
     ...
     *
     * <pre class="stHighlighted">
     * string should fullMatch regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                         ^
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): Assertion = {
     ...
     *
     * <pre class="stHighlighted">
     * string should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
     *                          ^
     * </pre>
     */
    def regex(rightRegex: Regex): Assertion = {
...
*/
  ...
  final class AnWord {
     ...
     *
     * <pre class="stHighlighted">
     * badBook should not be an (<span class="stQuotedString">'excellentRead</span>)
     *                          ^
     * </pre>
     */
  ...
  final class ResultOfHaveWordForExtent[A](left: A, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * obj should have length (<span class="stLiteral">2L</span>)
     *                 ^
     * </pre>
     *
     * <p>
     ...
     *
     * <pre class="stHighlighted">
     * obj should have size (<span class="stLiteral">2L</span>)
     *                 ^
     * </pre>
     *
     * <p>
     ...
     *
     * <pre class="stHighlighted">
     * exception should have message (<span class="stQuotedString">"file not found"</span>)
     *                       ^
     * </pre>
     */
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>) should contain (oneElementOf (<span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)))
   *                               ^
   * </pre>
   */
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>) should contain (atLeastOneElementOf (<span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)))
   *                               ^
   * </pre>
   */
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>) should contain (noElementsOf <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>))
   *                               ^
   * </pre>
   */
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>) should contain (allElementsOf(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>))
   *                               ^
   * </pre>
   */
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>) should contain (inOrderElementsOf <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>))
   *                               ^
   * </pre>
   */
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>) should contain (atMostOneElementOf (<span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)))
   *                               ^
   * </pre>
   */
...
*/
  ...
  final class ResultOfNotWordForCollectedAny[T](collected: Collected, xs: scala.collection.GenTraversable[T], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not equal (<span class="stLiteral">7</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not be (<span class="stLiteral">7</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not be definedAt (<span class="stQuotedString">"apple"</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not have length (<span class="stLiteral">0</span>)
     *                    ^
     * </pre>
     *
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not have size (<span class="stLiteral">0</span>)
     *                    ^
     * </pre>
     *
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(books) should not have (title (<span class="stQuotedString">"One Hundred Years of Solitude"</span>))
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not be (<span class="stReserved">null</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not be (<span class="stQuotedString">'empty</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not be a (<span class="stQuotedString">'file</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not be an (<span class="stQuotedString">'actionKey</span>)
     *                    ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain (<span class="stReserved">null</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain oneOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain oneElementOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain atLeastOneOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain atLeastOneElementOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain noneOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain noElementsOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain theSameElementsAs (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain theSameElementsInOrderAs (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain only (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain inOrderOnly (<span class="stQuotedString">"one"</span>, <span class="stQuotedString">"two"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain allOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain allElementsOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain inOrder (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain inOrderElementsOf (<span class="stType">List</span>(<span class="stQuotedString">"one"</span>))
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain atMostOneOf (<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should not contain atMostOneElementOf <span class="stType">List</span>(<span class="stQuotedString">"one"</span>)
     *                     ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(colOfMap) should not contain key (<span class="stQuotedString">"three"</span>)
     *                          ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(colOfMap) should not contain value (<span class="stLiteral">3</span>)
     *                          ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not startWith (<span class="stQuotedString">"1.7"</span>)
     *                        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not startWith regex (<span class="stQuotedString">"Hel*o"</span>)
     *                        ^
     * </pre>
     *
     * <p>
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not endWith (<span class="stQuotedString">"1.7"</span>)
     *                        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not endWith regex (<span class="stQuotedString">"wor.d"</span>)
     *                        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not include regex (<span class="stQuotedString">"wo.ld"</span>)
     *                        ^
     * </pre>
     *
     * <p>
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not include (<span class="stQuotedString">"world"</span>)
     *                        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should not fullyMatch regex (<span class="stQuotedString">"""(-)?(\d+)(\.\d*)?"""</span>)
     *                        ^
     * </pre>
     *
     * <p>
  ...
  final class ResultOfContainWordForCollectedAny[T](collected: Collected, xs: scala.collection.GenTraversable[T], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * option should contain oneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain oneElementOf <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain atLeastOneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain atLeastOneElementOf <span class="stType">List</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain noneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain noElementsOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain theSameElementsAs (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain theSameElementsInOrderAs (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain only (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain inOrderOnly (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain allOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain allElementsOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain inOrder (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * option should contain inOrderElementsOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                       ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should contain atMostOneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should contain atMostOneElementOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
     *                        ^
     * </pre>
     */
   ...
   /**
     ...
     *
     * <pre class="stHighlighted">
     * all(colOfMap) should contain key (<span class="stQuotedString">"one"</span>)
     *                              ^
     * </pre>
     */
   ...
   /**
     ...
     *
     * <pre class="stHighlighted">
     * all(colOfMap) should contain value (<span class="stLiteral">1</span>)
     *                              ^
     * </pre>
     */
  ...
  sealed class ResultOfBeWordForCollectedAny[T](collected: Collected, xs: scala.collection.GenTraversable[T], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should be a (<span class="stQuotedString">'file</span>)
     *                   ^
     * </pre>
     */
    def a(symbol: Symbol)(implicit toAnyRef: T <:< AnyRef): Assertion = {
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should be an (<span class="stQuotedString">'orange</span>)
     *                   ^
     * </pre>
     */
    def an(symbol: Symbol)(implicit toAnyRef: T <:< AnyRef): Assertion = {
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should be definedAt (<span class="stLiteral">6</span>)
     *                   ^
     * </pre>
     */
    def definedAt[U](right: U)(implicit ev: T <:< PartialFunction[U, _]): Assertion = {
  ...
  final class ResultOfBeWordForCollectedArray[T](collected: Collected, xs: scala.collection.GenTraversable[Array[T]], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position)
     ...
     *
     * <pre class="stHighlighted">
     * all(colOfArray) should be (<span class="stQuotedString">'empty</span>)
     *                           ^
     * </pre>
     */
...
*/
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should be (<span class="stLiteral">3</span>)
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) shouldEqual <span class="stLiteral">7</span>
     *          ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * result shouldEqual <span class="stLiteral">7.1</span> +- <span class="stLiteral">0.2</span>
     *        ^doCollected
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe a [<span class="stType">Type</span>]
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe an [<span class="stType">Type</span>]
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * result shouldEqual <span class="stReserved">null</span>
     *        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should equal (<span class="stLiteral">3</span>)
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should (equal (expected) and have length <span class="stLiteral">12</span>)
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) should not equal (<span class="stLiteral">3</span>)
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (results) should have length (<span class="stLiteral">3</span>)
     *        ^
     * all (results) should have size (<span class="stLiteral">3</span>)
     *        ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) shouldBe <span class="stLiteral">7</span>
     *          ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * all(<span class="stLiteral">4</span>, <span class="stLiteral">5</span>, <span class="stLiteral">6</span>) shouldBe &lt; (<span class="stLiteral">7</span>)
     *              ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(<span class="stLiteral">8</span>, <span class="stLiteral">9</span>, <span class="stLiteral">10</span>) shouldBe &gt; (<span class="stLiteral">7</span>)
     *               ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe <span class="stLiteral">7.1</span> +- <span class="stLiteral">0.2</span>
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe <span class="stQuotedString">'empty</span>
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe a (<span class="stQuotedString">'empty</span>)
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe an (<span class="stQuotedString">'empty</span>)
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldBe <span class="stReserved">null</span>
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldNot (be (<span class="stLiteral">3</span>))
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(xs) shouldNot (equal (<span class="stLiteral">3</span>))
     *         ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should === (<span class="stLiteral">100</span> +- <span class="stLiteral">1</span>)
     *          ^
     * </pre>
     */
   ...
   /**
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should contain oneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>)
     *          ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) shouldNot contain (oneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>))
     *          ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should startWith regex (<span class="stQuotedString">"Hel*o"</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should endWith regex (<span class="stQuotedString">"wo.ld"</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should include regex (<span class="stQuotedString">"wo.ld"</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should fullyMatch regex (<span class="stQuotedString">"""(-)?(\d+)(\.\d*)?"""</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) shouldNot fullyMatch regex (<span class="stQuotedString">"""(-)?(\d+)(\.\d*)?"""</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) shouldNot startWith regex (<span class="stQuotedString">"Hel*o"</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) shouldNot endWith regex (<span class="stQuotedString">"wo.ld"</span>)
     *             ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) shouldNot include regex (<span class="stQuotedString">"wo.ld"</span>)
     *             ^
     * </pre>
     */
  ...
  final class ResultOfHaveWordForCollectedExtent[A](collected: Collected, xs: scala.collection.GenTraversable[A], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should have length (<span class="stLiteral">12</span>)
     *                      ^
     * </pre>
     */
    def length(expectedLength: Long)(implicit len: Length[A]): Assertion = {
     ...
     *
     * <pre class="stHighlighted">
     * all (xs) should have size (<span class="stLiteral">12</span>)
     *                      ^
     * </pre>
     */
    def size(expectedSize: Long)(implicit sz: Size[A]): Assertion = {
  ...
  final class ResultOfStartWithWordForCollectedString(collected: Collected, xs: scala.collection.GenTraversable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should fullMatch regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                              ^
     * </pre>
     */
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should startWith regex (<span class="stQuotedString">"Hel*o"</span>.r)
     *                              ^
     * </pre>
     */
  ...
  final class ResultOfIncludeWordForCollectedString(collected: Collected, xs: scala.collection.GenTraversable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should include regex (<span class="stQuotedString">"world"</span>)
     *                            ^
     * </pre>
     */
    def regex(rightRegexString: String): Assertion = { checkRegex(rightRegexString.r) }
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should include regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                            ^
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): Assertion = { checkRegex(regexWithGroups.regex, regexWithGroups.groups) }
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should include regex (<span class="stQuotedString">"wo.ld"</span>.r)
     *                            ^
     * </pre>
     */
    def regex(rightRegex: Regex): Assertion = { checkRegex(rightRegex) }
  ...
  final class ResultOfEndWithWordForCollectedString(collected: Collected, xs: scala.collection.GenTraversable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should endWith regex (<span class="stQuotedString">"wor.d"</span>)
     *                            ^
     * </pre>
     */
    def regex(rightRegexString: String): Assertion = { checkRegex(rightRegexString.r) }
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should endWith regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                            ^
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): Assertion = { checkRegex(regexWithGroups.regex, regexWithGroups.groups) }
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should endWith regex (<span class="stQuotedString">"wor.d"</span>.r)
     *                            ^
     * </pre>
     */
    def regex(rightRegex: Regex): Assertion = { checkRegex(rightRegex) }
  ...
  final class ResultOfFullyMatchWordForCollectedString(collected: Collected, xs: scala.collection.GenTraversable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should fullMatch regex (<span class="stQuotedString">"Hel*o world"</span>)
     *                              ^
     * </pre>
     */
    def regex(rightRegexString: String): Assertion = { checkRegex(rightRegexString.r) }
     ...
     *
     * <pre class="stHighlighted">
     * all(string) should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
     *                               ^
     * </pre>
     */
    def regex(rightRegex: Regex): Assertion = { checkRegex(rightRegex) }
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * all(map) should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
    * ^
    * </pre>
    */
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * atLeast(<span class="stLiteral">1</span>, map) should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
    * ^
    * </pre>
    */
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * every(map) should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
    * ^
    * </pre>
    */
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * exactly(map) should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
    * ^
    * </pre>
    */
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * atMost(<span class="stLiteral">3</span>, map) should fullymatch regex (<span class="stQuotedString">"Hel*o world"</span>.r)
    * ^
    * </pre>
    */
  ...
  //DOTTY-ONLY }  // We need an empty AnyShouldWrapper for now.  
     ...
     *
     * <pre class="stHighlighted">
     * result should be (<span class="stLiteral">3</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * result should (equal (expected) and have length <span class="stLiteral">3</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * result should not equal (<span class="stLiteral">3</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * result should === (<span class="stLiteral">100</span> +- <span class="stLiteral">1</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * aDouble shouldBe <span class="stLiteral">8.8</span>
     *         ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * <span class="stLiteral">5</span> shouldBe &lt; (<span class="stLiteral">7</span>)
     *   ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * <span class="stLiteral">8</span> shouldBe &gt; (<span class="stLiteral">7</span>)
     *   ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     * <pre class="stHighlighted">
     * testing
     * <span class="stLiteral">1</span> shouldBe odd
     *   ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * result shouldBe <span class="stLiteral">7.1</span> +- <span class="stLiteral">0.2</span>
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * aDouble shouldBe a [<span class="stType">Book</span>]
     *         ^
     * </pre>
     */
    // SKIP-DOTTY-START
     ...
     *
     * <pre class="stHighlighted">
     * aDouble shouldBe an [<span class="stType">Book</span>]
     *         ^
     * </pre>
     */
    // SKIP-DOTTY-START
     ...
     *
     * <pre class="stHighlighted">
     * result shouldNot be (<span class="stLiteral">3</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * result shouldNot have length (<span class="stLiteral">3</span>)
     *        ^
     * result shouldNot have size (<span class="stLiteral">3</span>)
     *        ^
     * exception shouldNot have message (<span class="stQuotedString">"file not found"</span>)
     *           ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     * result should have length (<span class="stLiteral">3</span>)
     *        ^
     * result should have size (<span class="stLiteral">3</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * result shouldBe <span class="stReserved">null</span>
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
...
// TODO: Remember to write tests for inspector shorthands uncovering the bug below, always a empty because always true true passed to matchSym
     ...
     *
     * <pre class="stHighlighted">
     * list shouldBe <span class="stQuotedString">'empty</span>
     *      ^
     * </pre>
     */
    // SKIP-SCALATESTJS,NATIVE-END 
     ...
     *
     * <pre class="stHighlighted">
     * list shouldBe a (<span class="stQuotedString">'empty</span>)
     *      ^
     * </pre>
     */
    // SKIP-SCALATESTJS,NATIVE-END
     ...
     *
     * <pre class="stHighlighted">
     * list shouldBe an (<span class="stQuotedString">'empty</span>)
     *      ^
     * </pre>
     */
    // SKIP-SCALATESTJS,NATIVE-END
...
*/
   ...
   /**
     ...
     *
     * <pre class="stHighlighted">
     * xs should contain oneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>)
     *    ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * xs shouldNot contain (oneOf (<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>))
     *    ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string should include regex (<span class="stQuotedString">"hi"</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string should startWith regex (<span class="stQuotedString">"hello"</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string should endWith regex (<span class="stQuotedString">"world"</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string shouldNot startWith regex (<span class="stQuotedString">"hello"</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string shouldNot endWith regex (<span class="stQuotedString">"world"</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string shouldNot include regex (<span class="stQuotedString">"hi"</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
  ...
  // SKIP-DOTTY-END
     ...
     *
     * <pre class="stHighlighted">
     * string should fullyMatch regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                                          ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string should fullyMatch regex (<span class="stQuotedString">"a(b*)(c*)"</span> withGroups (<span class="stQuotedString">"bb"</span>, <span class="stQuotedString">"cc"</span>))
     *                                             ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * string shouldNot fullyMatch regex (<span class="stQuotedString">"""(-)?(\d+)(\.\d*)?"""</span>)
     *        ^
     * </pre>
     */
    // SKIP-DOTTY-START 
  ...
  // SKIP-DOTTY-END  
     ...
     *
     * <pre class="stHighlighted">
     * regex should fullyMatch regex (<span class="stQuotedString">"a(b*)c"</span> withGroup <span class="stQuotedString">"bb"</span>)
     *                                         ^
     * </pre>
     */
    // SKIP-DOTTY-START 
     ...
     *
     * <pre class="stHighlighted">
     * regex should fullyMatch regex (<span class="stQuotedString">"a(b*)(c*)"</span> withGroups (<span class="stQuotedString">"bb"</span>, <span class="stQuotedString">"cc"</span>))
     *                                            ^
     * </pre>
     */
    // SKIP-DOTTY-START 
