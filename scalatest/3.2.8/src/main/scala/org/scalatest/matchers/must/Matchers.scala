...
*/
  ...
  // SKIP-DOTTY-END
    ...
    // SKIP-DOTTY-END
    //DOTTY-ONLY extension (inline leftSideString: String)(using pos: source.Position, prettifier: Prettifier) transparent inline def mustNot(typeCheckWord: TypeCheckWord): Assertion = ${ org.scalatest.matchers.must.CompileMacro.mustNotTypeCheckImpl('{leftSideString}, '{typeChecks(leftSideString)}, '{typeCheckWord})('{pos}) }
  // SKIP-DOTTY-START
  }
  // SKIP-DOTTY-END
