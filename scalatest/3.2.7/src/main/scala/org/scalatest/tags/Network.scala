...
/**
 * Annotation used to tag a test, or suite of tests, as being network-intensive (<em>i.e.</em>, consuming a large amount of network bandwidth when it runs).
 *
 * <p>
 ...
 *
 * <p>
 * If you wish to mark an entire suite of tests as being network-intensive, you can annotate the test class with <code>@Network</code>, like this:
 * </p>
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.flatspec.networkall
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> tags.Network
 * <br/>@<span class="stType">Network</span>
 ...
 *
 * <p>
 * Another use case for <code>@Network</code> is to mark test <em>methods</em> as network-intensive in traits <a href="Spec.html"><code>Spec</code></a>
 * and <a href="fixture/Spec.html"><code>fixture.Spec</code></a>. Here's an example:
 * </p>
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.network
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> tags.Network
 ...
 * <br/>  @<span class="stType">Network</span> <span class="stReserved">def</span> <span class="literalIdentifier">&#96;an empty Set should have size 0&#96;</span> {
 *     assert(Set.empty.size === <span class="stLiteral">0</span>)
 *   }
 ...
 */
 ...
 trait Network extends java.lang.annotation.Annotation 
