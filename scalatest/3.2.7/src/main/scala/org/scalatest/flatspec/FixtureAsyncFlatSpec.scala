...
/**
 * A sister class to <code>org.scalatest.flatspec.AsyncFlatSpec</code> that can pass a fixture object into its tests.
 *
 ...
 *
 * <p>
 * Class <code>FixtureAsyncFlatSpec</code> behaves similarly to class <code>org.scalatest.flatspec.AsyncFlatSpec</code>, except that tests may have a
 ...
 *
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.flatspec.AsyncFlatSpec</code>:
 * </p>
 *
 * <ol>
 ...
 * @author Bill Venners
 */
abstract class FixtureAsyncFlatSpec extends org.scalatest.flatspec.FixtureAsyncFlatSpecLike {
