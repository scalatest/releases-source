...
/**
  ...
  * <br/><span class="stReserved">import</span> org.scalatest.funsuite.AsyncFunSuite
  ...
  * <br/><span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AsyncFunSuite</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
  ...
  *
  *
  * If you run this <code>AsyncFunSuite</code> from the interpreter, you will see the following output:
  *
  * <pre class="stREPL">
  ...
  *
  * <p>
  * Here's an example <code>AsyncFunSuite</code> that uses <code>markup</code>:
  * </p>
  *
  * <pre class="stHighlighted">
  ...
  * <br/><span class="stReserved">import</span> collection.mutable
  * <span class="stReserved">import</span> org.scalatest._
  * <br/><span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AsyncFunSuite</span> {
  * <br/>  test(<span class="stQuotedString">"An element can be added to an empty mutable Set"</span>) {
  ...
  *
  * <pre class="stHighlighted">
  * <span class="stReserved">import</span> org.scalatest.funsuite.AsyncFunSuite
  ...
  * <span class="stReserved">import</span> org.scalatest._
  * <span class="stReserved">import</span> scala.concurrent.Future
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AsyncFunSuite</span> {
  ...
  *     }
  * }
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.FixtureAsyncFunSuite</span> {
  ...
  *   }
  * }
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AsyncFunSuite</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
  * <br/>  test(<span class="stQuotedString">"Testing should be easy"</span>) {
  ...
  *
  * <pre class="stHighlighted">
  * <span class="stReserved">class</span> <span class="stType">Example2Suite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AsyncFunSuite</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
  * </pre>
  *
  * <p>
  ...
  *
  * <pre class="stHighlighted">
  * <span class="stReserved">class</span> <span class="stType">Example3Suite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AsyncFunSuite</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
  * </pre>
  *
  * <p>
