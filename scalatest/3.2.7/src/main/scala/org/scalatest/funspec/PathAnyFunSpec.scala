...
/**
 * A sister class to <code>org.scalatest.funspec.AnyFunSpec</code> that isolates tests by running each test in its own
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">funspec.PathAnyFunSpec</span> <span class="stReserved">with</span> <span class="stType">Matchers</span> {
