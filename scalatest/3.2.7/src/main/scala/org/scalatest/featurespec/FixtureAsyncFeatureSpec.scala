 ...
 * that must be cleaned up afterwards. <em>Note: <code>FixtureAsyncFeatureSpec</code> is intended for use in special situations, with class <code>AsyncFeatureSpec</code> used for general needs. For
 * more insight into where <code>FixtureAsyncFeatureSpec</code> fits in the big picture, see the <a href="AsyncFeatureSpec.html#withFixtureOneArgAsyncTest"><code>withFixture(OneArgAsyncTest)</code></a> subsection of the <a href="AsyncFeatureSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class <code>AsyncFeatureSpec</code>.</em>
 * </td></tr></table>
 *
 * <p>
 * Class <code>FixtureAsyncFeatureSpec</code> behaves similarly to class <code>org.scalatest.featurespec.AsyncFeatureSpec</code>, except that tests may have a
 ...
 *
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.featurespec.AsyncFeatureSpec</code>:
 * </p>
 *
 * <ol>
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.FixtureAsyncFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">DbFixture</span> {
 ...
 *   }
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"Testing should be easy to write"</span>) { db =&gt;
 *       <span class="stType">Future</span> {
 ...
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Testing should be fun"</span>) { db =&gt;
 *       <span class="stType">Future</span> {
 ...
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"Testing code should be clear"</span>) { () =&gt;
 *       <span class="stType">Future</span> {
