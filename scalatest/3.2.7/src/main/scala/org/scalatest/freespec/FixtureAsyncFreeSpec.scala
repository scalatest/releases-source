...
/**
 * A sister class to <code>org.scalatest.freespec.AsyncFreeSpec</code> that can pass a fixture object into its tests.
 *
 * <table><tr><td class="usage">
 * <strong>Recommended Usage</strong>:
 * Use class <code>FixtureAsyncFunSpec</code> in situations for which <a href="AsyncFreeSpec.html"><code>AsyncFreeSpec</code></a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. <em>Note: <code>FixtureAsyncFreeSpec</code> is intended for use in special situations, with class <code>AsyncFreeSpec</code> used for general needs. For
 * more insight into where <code>FixtureAsyncFreeSpec</code> fits in the big picture, see the <a href="AsyncFreeSpec.html#withFixtureOneArgAsyncTest"><code>withFixture(OneArgAsyncTest)</code></a> subsection of the <a href="../AsyncFunSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class <code>AsyncFunSpec</code>.</em>
 * </td></tr></table>
 *
 * <p>
 * Class <code>FixtureAsyncFreeSpec</code> behaves similarly to class <code>org.scalatest.freespec.AsyncFreeSpec</code>, except that tests may have a
 ...
 *
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.freespec.AsyncFunSpec</code>:
 * </p>
 *
 * <ol>
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">freespec.FixtureAsyncFreeSpec</span> <span class="stReserved">with</span> <span class="stType">DbFixture</span> {
 ...
 * @author Bill Venners
 */
abstract class FixtureAsyncFreeSpec extends org.scalatest.freespec.FixtureAsyncFreeSpecLike {
