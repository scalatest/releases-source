...
/**
 * A sister class to <code>org.scalatest.wordspec.AnyWordSpec</code> that can pass a fixture object into its tests.
 *
 * <table><tr><td class="usage">
 * <strong>Recommended Usage</strong>:
 * Use class <code>FixtureAnyWordSpec</code> in situations for which <a href="AnyWordSpec.html"><code>AnyWordSpec</code></a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. <em>Note: <code>FixtureAnyWordSpec</code> is intended for use in special situations, with class <code>AnyWordSpec</code> used for general needs. For
 * more insight into where <code>FixtureAnyWordSpec</code> fits in the big picture, see the <a href="AnyWordSpec.html#withFixtureOneArgTest"><code>withFixture(OneArgTest)</code></a> subsection of the <a href="AnyWordSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class <code>AnyWordSpec</code>.</em>
 * </td></tr></table>
 * 
 * <p>
 * Class <code>FixtureAnyWordSpec</code> behaves similarly to class <code>org.scalatest.wordspec.AnyWordSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.wordspec.AnyWordSpec</code>:
 * </p>
 * 
 * <ol>
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.FixtureAnyWordSpec</span> <span class="stReserved">with</span> <span class="stType">DbFixture</span> {
...
abstract class FixtureAnyWordSpec extends org.scalatest.wordspec.FixtureAnyWordSpecLike {
