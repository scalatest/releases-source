...
// TODO: Make elements a Sequencing
   ...
   * (<span class="stType">List</span>(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>) should contain inOrderOnly (<span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * (<span class="stType">SortedSet</span>(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>) should contain inOrderOnly (<span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stLineComment">// lowerCased needs to be implemented as Normalization[(K, V)]</span>
   * (<span class="stType">SortedMap</span>(<span class="stQuotedString">"hi"</span> -> <span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span> -> <span class="stQuotedString">"he"</span>) should contain inOrderOnly (<span class="stQuotedString">"HI"</span> -> <span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span> -> <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
   ...
   *
   * <pre class="stHighlighted">
   * (<span class="stType">Array</span>(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>) should contain inOrderOnly (<span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
   ...
   * javaList.add(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>)
   * (javaList should contain (<span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stReserved">val</span> javaSet = <span class="stReserved">new</span> <span class="stType">java.util.TreeSet[String]</span>()
   * javaSet.add(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>)
   * (javaSet should contain inOrderOnly (<span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stReserved">val</span> javaMap = <span class="stReserved">new</span> <span class="stType">java.util.TreeMap[Int, String]</span>()
   ...
   * (javaMap should contain inOrderOnly (<span class="stType">Entry</span>(<span class="stLiteral">1</span>, <span class="stQuotedString">"ONE"</span>))) (after being lowerCased)
   * </pre>
   *
   ...
   * (<span class="stQuotedString">"hi hello"</span> should contain inOrderOnly (<span class="stQuotedString">'E'</span>)) (after being lowerCased)
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * (<span class="stType">Every</span>(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>) should contain inOrderOnly (<span class="stQuotedString">"HI"</span>, <span class="stQuotedString">"HE"</span>)) (after being lowerCased)
   * </pre>
   *
   * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
