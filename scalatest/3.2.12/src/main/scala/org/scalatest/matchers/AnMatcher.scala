 ...
 *
 * <pre class="stHighlighted">
 * <span class="stLineComment">// Using AnMatcher.apply method</span>
 * <span class="stReserved">val</span> oddNumber = <span class="stType">AnMatcher[Int]</span>(<span class="stQuotedString">"odd number"</span>){ _ % <span class="stLiteral">2</span> != <span class="stLiteral">0</span> }
 * <br/><span class="stLineComment">// Or by extending AnMatcher trait</span>
 * <span class="stReserved">val</span> evenNumber = <span class="stReserved">new</span> <span class="stType">AnMatcher[Int]</span> {
 *   <span class="stReserved">val</span> nounName = <span class="stQuotedString">"even number"</span>
 ...
 *       left % <span class="stLiteral">2</span> == <span class="stLiteral">0</span>,
 *       left + <span class="stQuotedString">" was not an "</span> + nounName,
 *       left + <span class="stQuotedString">" was an "</span> + nounName
 *     )
 * }
 * </pre>
 *
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">val</span> num1 = <span class="stLiteral">1</span>
 * num1 should be an oddNumber
 * <br/><span class="stReserved">val</span> num2 = num1 + <span class="stLiteral">1</span>
 * num2 should be an evenNumber
 * <br/>num1 should be an evenNumber
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stLiteral">1</span> was not an even number
 * </pre>
 *
 * <p>
