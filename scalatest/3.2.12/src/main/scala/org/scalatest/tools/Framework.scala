 ...
 * <span class="stQuotedString">"org.scalatest"</span> % <span class="stQuotedString">"scalatest_2.10"</span> % <span class="stQuotedString">"2.0"</span> % <span class="stQuotedString">"test"</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * testOptions in <span class="stType">Test</span> += <span class="stType">Tests.Argument</span>(<span class="stQuotedString">"-h"</span>, <span class="stQuotedString">"target/html"</span>)  <span class="stLineComment">// Use HtmlReporter</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * testOptions in <span class="stType">Test</span> += <span class="stType">Tests.Argument</span>(<span class="stType">TestFrameworks.ScalaTest</span>, <span class="stQuotedString">"-h"</span>, <span class="stQuotedString">"target/html"</span>) <span class="stLineComment">// Use HtmlReporter</span>
 * </pre>
 *
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">import</span> java.lang.annotation.Target;
 * <span class="stReserved">import</span> java.lang.annotation.Retention;
 * <span class="stReserved">import</span> org.scalatest.TagAnnotation;
 * <br/>@<span class="stType">TagAnnotation</span>(<span class="stQuotedString">"custom"</span>)
 * @<span class="stType">Retention</span>(RetentionPolicy.RUNTIME)
 * @<span class="stType">Target</span>({ElementType.TYPE})
 * public @interface <span class="stType">Custom</span> {}
 * </pre>
 *
 * <p>
