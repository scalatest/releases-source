...
/**
 * A sister class to <code>org.scalatest.freespec.AnyFreeSpec</code> that can pass a fixture object into its tests.
 *
 * <table><tr><td class="usage">
 * <strong>Recommended Usage</strong>:
 * Use class <code>FixtureAnyFreeSpec</code> in situations for which <a href="AnyFreeSpec.html"><code>AnyFreeSpec</code></a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. <em>Note: <code>FixtureAnyFreeSpec</code> is intended for use in special situations, with class <code>AnyFreeSpec</code> used for general needs. For
 * more insight into where <code>FixtureAnyFreeSpec</code> fits in the big picture, see the <a href="AnyFreeSpec.html#withFixtureOneArgTest"><code>withFixture(OneArgTest)</code></a> subsection of the <a href="AnyFreeSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class <code>AnyFreeSpec</code>.</em>
 * </td></tr></table>
 * 
 * <p>
 * Class <code>FixtureAnyFreeSpec</code> behaves similarly to class <code>org.scalatest.freespec.AnyFreeSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.freespec.AnyFreeSpec</code>:
 * </p>
 * 
 * <ol>
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">FixtureAnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">DbFixture</span> {
...
abstract class FixtureAnyFreeSpec extends org.scalatest.freespec.FixtureAnyFreeSpecLike {
