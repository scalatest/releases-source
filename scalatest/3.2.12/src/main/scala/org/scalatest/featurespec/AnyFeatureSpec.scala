 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">TVSetSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"TV power button"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User presses power button when TV is off"</span>) {
 ...
 *       assert(tv.isOn)
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User presses power button when TV is on"</span>) {
 ...
 * <br/><span class="stReserved">import</span> org.scalatest.featurespec.AnyFeatureSpec
 * <br/><span class="stReserved">class</span> <span class="stType">TVSet</span> {
 *   <span class="stReserved">private</span> <span class="stReserved">var</span> on: <span class="stType">Boolean</span> = <span class="stReserved">false</span>
 *   <span class="stReserved">def</span> isOn: <span class="stType">Boolean</span> = on
 *   <span class="stReserved">def</span> pressPowerButton() {
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">TVSetSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"TV power button"</span>) {
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 * <span class="stQuotedString"></span>
 *   <span class="stQuotedString">"""</span> }
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"An element can be added to an empty mutable Set"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"When an element is added to an empty mutable Set"</span>) {
 ...
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AnyFeatureSpec</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"An element can be added to an empty mutable Set"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"When an element is added to an empty mutable Set"</span>) {
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">TVSetSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"TV power button"</span>) {
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User presses power button when TV is off"</span>) (pending)
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User presses power button when TV is on"</span>) {
 *       <span class="stReserved">val</span> tv = <span class="stReserved">new</span> <span class="stType">TVSet</span>
 *       tv.pressPowerButton()
 *       assert(tv.isOn)
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">TVSetSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"TV power button"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User presses power button when TV is off"</span>, <span class="stType">Slow</span>) {
 *       <span class="stReserved">val</span> tv = <span class="stReserved">new</span> <span class="stType">TVSet</span>
 *       assert(!tv.isOn)
 *       tv.pressPowerButton()
 *       assert(tv.isOn)
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User presses power button when TV is on"</span>, <span class="stType">Slow</span>, <span class="stType">DbTest</span>) {
 *       <span class="stReserved">val</span> tv = <span class="stReserved">new</span> <span class="stType">TVSet</span>
 *       tv.pressPowerButton()
 *       assert(tv.isOn)
 *       tv.pressPowerButton()
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> {
 ...
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to read test code written by others"</span>) {
 ...
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to understand what the tests are doing"</span>) {
 *       <span class="stReserved">val</span> f = fixture
 ...
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to understand what the tests are doing"</span>) {
 ...
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to write tests"</span>) {
 ...
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AnyFeatureSpec</span> {
 ...
 *     }
 *   }
 * <br/>  <span class="stType">Scenario</span>(<span class="stQuotedString">"This scenario should succeed"</span>) {
 *     assert(<span class="stLiteral">1</span> + <span class="stLiteral">1</span> === <span class="stLiteral">2</span>)
 *   }
 * <br/>  <span class="stType">Scenario</span>(<span class="stQuotedString">"This scenario should fail"</span>) {
 ...
 * <span class="stReserved">import</span> java.io._
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.FixtureAnyFeatureSpec</span> {
 ...
 *   }
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to read test code written by others"</span>) { f =&gt;
 *       f.writer.write(<span class="stQuotedString">"encourage clear code!"</span>)
 *       f.writer.flush()
 *       assert(f.file.length === <span class="stLiteral">49</span>)
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to understand what the tests are doing"</span>) { f =&gt;
 ...
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> collection.mutable.ListBuffer
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">BeforeAndAfter</span> {
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to read test code written by others"</span>) {
 *       builder.append(<span class="stQuotedString">"encourage clear code!"</span>)
 *       assert(builder.toString === <span class="stQuotedString">"ScalaTest is designed to encourage clear code!"</span>)
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example2Spec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example3Spec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 * <br/><span class="stReserved">trait</span> <span class="stType">FeatureSpecStackBehaviors</span> { <span class="stReserved">this</span>: <span class="stType">AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> =&gt;
 ...
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"empty is invoked on this non-empty stack: "</span> + createNonEmptyStack.toString) {
 ...
 *       assert(!stack.empty)
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"peek is invoked on this non-empty stack: "</span> + createNonEmptyStack.toString) {
 * <br/>      <span class="stType">Given</span>(<span class="stQuotedString">"a non-empty stack"</span>)
 *       <span class="stReserved">val</span> stack = createNonEmptyStack
 ...
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"pop is invoked on this non-empty stack: "</span> + createNonEmptyStack.toString) {
 * <br/>      <span class="stType">Given</span>(<span class="stQuotedString">"a non-empty stack"</span>)
 *       <span class="stReserved">val</span> stack = createNonEmptyStack
 *       <span class="stReserved">val</span> size = stack.size
 ...
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"full is invoked on this non-full stack: "</span> + createNonFullStack.toString) {
 ...
 *       assert(!stack.full)
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"push is invoked on this non-full stack: "</span> + createNonFullStack.toString) {
 * <br/>      <span class="stType">Given</span>(<span class="stQuotedString">"a non-full stack"</span>)
 *       <span class="stReserved">val</span> stack = createNonFullStack
 *       <span class="stReserved">val</span> size = stack.size
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">ScenariosFor</span>(nonEmptyStack(stackWithOneItem, lastValuePushed))
 * <span class="stType">ScenariosFor</span>(nonFullStack(stackWithOneItem))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">ScenariosFor</span>(nonEmptyStack) <span class="stLineComment">// assuming lastValuePushed is also in scope inside nonEmptyStack</span>
 * <span class="stType">ScenariosFor</span>(nonFullStack)
 * </pre>
 *
 * <p>
 ...
 * <span class="stReserved">import</span> org.scalatest.GivenWhenThen
 * <span class="stReserved">import</span> org.scalatestexamples.helpers.Stack
 * <br/><span class="stReserved">class</span> <span class="stType">StackFeatureSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> <span class="stReserved">with</span> <span class="stType">FeatureSpecStackBehaviors</span> {
 ...
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"A Stack is pushed and popped"</span>) {
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"empty is invoked on an empty stack"</span>) {
 ...
 *       assert(stack.empty)
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"peek is invoked on an empty stack"</span>) {
 * <br/>      <span class="stType">Given</span>(<span class="stQuotedString">"an empty stack"</span>)
 *       <span class="stReserved">val</span> stack = emptyStack
 * <br/>      <span class="stType">When</span>(<span class="stQuotedString">"peek is invoked on the stack"</span>)
 ...
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"pop is invoked on an empty stack"</span>) {
 * <br/>      <span class="stType">Given</span>(<span class="stQuotedString">"an empty stack"</span>)
 *       <span class="stReserved">val</span> stack = emptyStack
 * <br/>      <span class="stType">When</span>(<span class="stQuotedString">"pop is invoked on the stack"</span>)
 ...
 *       }
 *     }
 * <br/>    <span class="stType">ScenariosFor</span>(nonEmptyStack(stackWithOneItem, lastValuePushed))
 *     <span class="stType">ScenariosFor</span>(nonFullStack(stackWithOneItem))
 * <br/>    <span class="stType">ScenariosFor</span>(nonEmptyStack(stackWithOneItemLessThanCapacity, lastValuePushed))
 *     <span class="stType">ScenariosFor</span>(nonFullStack(stackWithOneItemLessThanCapacity))
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"full is invoked on a full stack"</span>) {
 ...
 *       assert(stack.full)
 *     }
 * <br/>    <span class="stType">ScenariosFor</span>(nonEmptyStack(fullStack, lastValuePushed))
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"push is invoked on a full stack"</span>) {
 * <br/>      <span class="stType">Given</span>(<span class="stQuotedString">"an full stack"</span>)
 *       <span class="stReserved">val</span> stack = fullStack
 * <br/>      <span class="stType">When</span>(<span class="stQuotedString">"push is invoked on the stack"</span>)
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">ScenariosFor</span>(nonEmptyStack(stackWithOneItemLessThanCapacity, lastValuePushed))
 * </pre>
 *
 * <p>
