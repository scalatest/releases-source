...
/**
 * Implementation trait for class <code>FixtureAsyncWordSpec</code>, which is
 * a sister class to <a href="AsyncWordSpec.html"><code>org.scalatest.wordspec.AsyncWordSpec</code></a> that can pass a
 * fixture object into its tests.
 *
 * <p>
 * <a href="FixtureAsyncWordSpec.html"><code>FixtureAsyncWordSpec</code></a> is a class,
 * not a trait, to minimize compile time given there is a slight compiler
 * overhead to mixing in traits compared to extending classes. If you need
 * to mix the behavior of <code>FixtureAsyncWordSpec</code> into some other
 * class, you can use this trait instead, because class
 * <code>FixtureAsyncWordSpec</code> does nothing more than extend this trait and add a nice <code>toString</code> implementation.
 * </p>
 *
 * <p>
 * See the documentation of the class for a <a href="FixtureAsyncWordSpec.html">detailed
 * overview of <code>FixtureAsyncWordSpec</code></a>.
 * </p>
 *
 * @author Bill Venners
 */
...
trait FixtureAsyncWordSpecLike extends org.scalatest.FixtureAsyncTestSuite with org.scalatest.FixtureAsyncTestRegistration with ShouldVerb with MustVerb with CanVerb with Informing with Notifying with Alerting with Documenting { thisSuite =>
   ...
   * <code>FixtureAsyncWordSpec</code> is being executed, such as from inside a test function, it will forward the information to
   ...
   * this <code>FixtureAsyncWordSpec</code> instance.
   *
  ...
  private def registerPendingTestToRun(specText: String, testTags: List[Tag], methodName: String, testFun: FixtureParam => PendingStatement, pos: source.Position): Unit = {
    engine.registerAsyncTest(specText, org.scalatest.fixture.AsyncPendingTransformer(testFun), Resources.inCannotAppearInsideAnotherIn, None, None, pos, testTags: _*)
  }
  ...
  private def registerPendingTestToIgnore(specText: String, testTags: List[Tag], methodName: String, testFun: FixtureParam => PendingStatement, pos: source.Position): Unit = {
    engine.registerIgnoredAsyncTest(specText, org.scalatest.fixture.AsyncPendingTransformer(testFun), Resources.ignoreCannotAppearInsideAnIn, None, pos, testTags: _*)
  }
   ...
   *
   * <p>
   * This class provides much of the syntax for <code>FixtureAsyncWordSpec</code>, however, it does not add
   ...
   * traits, which <code>FixtureAsyncWordSpec</code> mixes in, to avoid a conflict with implicit conversions provided
   ...
   * <span class="stReserved">import</span> ConfigMapFixture
   * <br/><span class="stReserved">class</span> <span class="stType">ScalaTestGUISpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.FixtureAnyWordSpec</span> <span class="stReserved">with</span> <span class="stType">ConfigMapFixture</span> {
   ...
   *       <span class="stQuotedString">"a blue background in the clicked-on row in the list box"</span> in { cm =&gt; }
   *       <span class="stQuotedString">"the details for the event in the details area"</span> in { cm =&gt; }
   *       <span class="stQuotedString">"a rerun button,"</span> which is {
   *         <span class="stQuotedString">"enabled if the clicked-on event is rerunnable"</span> in { cm =&gt; }
   *         <span class="stQuotedString">"disabled if the clicked-on event is not rerunnable"</span> in { cm =&gt; }
   *       }
   *     }
   *   }
   * }
  ...
  /**
   * Class that supports shorthand scope registration via the instance referenced from <code>FixtureAsyncWordSpecLike</code>'s <code>it</code> field.
   *
   * <p>
   ...
   * for <code>FixtureAsyncWordSpec</code>.
   * </p>
   */
  protected final class ItWord {
     ...
     *
     * <p>
     * For examples of scope registration, see the <a href="FixtureAsyncWordSpec.html">main documentation</a>
     * for <code>FixtureAsyncWordSpec</code>.
     * </p>
     *
    ...
    /**
     * Supports the registration of scope with <code>must</code> in a <code>FixtureAsyncWordSpecLike</code>.
     *
     * <p>
     * This method supports syntax such as the following:
     * </p>
    ...
    /**
     * Supports the registration of scope with <code>can</code> in a <code>FixtureAsyncWordSpecLike</code>.
     *
     * <p>
     * This method supports syntax such as the following:
     * </p>
    ...
    /**
     * Supports the registration of scope with <code>when</code> in a <code>FixtureAsyncWordSpecLike</code>.
     *
     * <p>
     * This method supports syntax such as the following:
     * </p>
  ...
  /**
   * Supports shorthand scope registration in <code>FixtureAsyncWordSpecLike</code>s.
   *
   * <p>
  ...
  /**
   * Class that supports shorthand scope registration via the instance referenced from <code>FixtureAsyncWordSpecLike</code>'s <code>they</code> field.
   *
   * <p>
   * This class enables syntax such as the following test registration:
   * </p>
  ...
  protected final class TheyWord {
     ...
     *
     * <pre class="stHighlighted">
     * <span class="stQuotedString">"Basketball players"</span> should { ... }
     * <br/>they when { ... }
     *      ^
     * </pre>
     *
  ...
  /**
   * A <code>Map</code> whose keys are <code>String</code> tag names to which tests in this <code>FixtureAsyncWordSpec</code> belong, and values
   * the <code>Set</code> of test names that belong to each tag. If this <code>FixtureAsyncWordSpec</code> contains no tags, this method returns an empty <code>Map</code>.
   *
   * <p>
  ...
  /**
   * <p>
   * Run zero to many of this <code>FixtureAsyncWordSpec</code>'s tests.
   * </p>
   *
   * <p>
   ...
   *                 I.e., <code>None</code> acts like a wildcard that means execute all relevant tests in this <code>FixtureAsyncWordSpec</code>.
   * @param args the <code>Args</code> for this run
