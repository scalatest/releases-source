 ...
 *
 * <p>
 * If all or most tests need the same fixture, you can avoid some of the boilerplate of the loan-fixture method approach by using a <code>FixtureAnyFlatSpec</code>
 ...
 * the objects.  For more information on the <code>withFixture(OneArgTest)</code> technique, see the <a href="FixtureAnyFlatSpec.html">documentation for <code>FixtureAnyFlatSpec</code></a>.
 * </p>
 *
 ...
 * contain will be registered as tests in that <code>AnyFlatSpec</code>.  For example, given this stack class:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 *
 * <p>
 * Given these behavior functions, you could invoke them directly, but <code>AnyFlatSpec</code> offers a DSL for the purpose,
 ...
 * For example, the following code in a <code>AnyFlatSpec</code> would register a test with the name <code>"A Stack (when empty) should be empty"</code>:
 * </p>
 *
 * <pre class="stHighlighted">
