...
trait AppendedClues {
  ...
  class Clueful[T](fun: => T) {
     ...
     *
     * <pre class="stHighlighted">
     * { <span class="stLiteral">1</span> + <span class="stLiteral">1</span> should equal (<span class="stLiteral">3</span>) } withClue <span class="stQuotedString">", not even for very large values of 1"</span>
     * </pre>
     *
     * <p>
