...
/**
  ...
  *   }
  * }
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.FixtureAnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">DbFixture</span> {
