...
trait MatcherProducers {
   ...
   * <span class="stReserved">import</span> MatcherProducers._
   * <br/><span class="stReserved">val</span> f = be &gt; (_: <span class="stType">Int</span>)
   * <span class="stReserved">val</span> g = (_: <span class="stType">String</span>).toInt
   * <br/><span class="stLineComment">// f composeTwice g means: (f compose g) andThen (_ compose g)</span>
   * <span class="stReserved">val</span> beAsIntsGreaterThan =
   *   f composeTwice g mapResult { mr =&gt;
   *     mr.copy(
   *       failureMessageArgs =
   *         mr.failureMessageArgs.map((<span class="stType">LazyArg</span>(_) { <span class="stQuotedString">"\""</span> + _.toString + <span class="stQuotedString">"\".toInt"</span>})),
   *       negatedFailureMessageArgs =
   *         mr.negatedFailureMessageArgs.map((<span class="stType">LazyArg</span>(_) { <span class="stQuotedString">"\""</span> + _.toString + <span class="stQuotedString">"\".toInt"</span>})),
   *       midSentenceFailureMessageArgs =
   *         mr.midSentenceFailureMessageArgs.map((<span class="stType">LazyArg</span>(_) { <span class="stQuotedString">"\""</span> + _.toString + <span class="stQuotedString">"\".toInt"</span>})),
   *       midSentenceNegatedFailureMessageArgs =
   *         mr.midSentenceNegatedFailureMessageArgs.map((<span class="stType">LazyArg</span>(_) { <span class="stQuotedString">"\""</span> + _.toString + <span class="stQuotedString">"\".toInt"</span>}))
   *     )
   *   }
   * <br/><span class="stQuotedString">"7"</span> should beAsIntsGreaterThan (<span class="stQuotedString">"8"</span>)
   * </pre>
   *
   * The last assertion will fail with message like this:
   *
   * <pre class="stHighlighted">
   * <span class="stQuotedString">"7"</span>.toInt was not greater than <span class="stQuotedString">"8"</span>.toInt
   * </pre>
   *
