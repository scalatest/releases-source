 ...
 *
 * <pre class="stHighlighted">
 * <span class="stLineComment">// Using AMatcher.apply method</span>
 * <span class="stReserved">val</span> positiveNumber = <span class="stType">AMatcher[Int]</span>(<span class="stQuotedString">"positive number"</span>){ _ > <span class="stLiteral">0</span> }
 * <br/><span class="stLineComment">// Or by extending AMatcher trait</span>
 * <span class="stReserved">val</span> negativeNumber = <span class="stReserved">new</span> <span class="stType">AMatcher[Int]</span> {
 *   <span class="stReserved">val</span> nounName = <span class="stQuotedString">"negative number"</span>
 ...
 *       left < <span class="stLiteral">0</span>,
 *       left + <span class="stQuotedString">" was not a "</span> + nounName,
 *       left + <span class="stQuotedString">" was a "</span> + nounName
 *     )
 * }
 * </pre>
 *
 ...
 * <br/>num1 should be a negativeNumber
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stLiteral">1</span> was not a negative number
 * </pre>
 *
 * <p>
