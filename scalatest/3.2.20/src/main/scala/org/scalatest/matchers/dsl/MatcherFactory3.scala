...
abstract class MatcherFactory3[-SC, TC1[_], TC2[_], TC3[_]] { thisMatcherFactory =>
   ...
   * implicit parameter (for example, a <code>TC1[T]</code>, <code>TC2[T]</code>, <em>etc.</em>).
   */
  def matcher[T <: SC : TC1 : TC2 : TC3]: Matcher[T]
  ...
  final class AndHaveWord {
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>:
     *
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory4[SC, TC1, TC2, TC3, Length] = and(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory4[SC, TC1, TC2, TC3, Size] = and(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory4[SC, TC1, TC2, TC3, Messaging] = and(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class AndContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory4[SC, TC1, TC2, TC3, Containing] = thisMatcherFactory.and(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory4[SC, TC1, TC2, TC3, KeyMapping] = thisMatcherFactory.and(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory4[SC, TC1, TC2, TC3, ValueMapping] = thisMatcherFactory.and(MatcherWords.contain.value(expectedValue))
     ...
     * </pre>
     */
    def theSameElementsAs(right: GenTraversable[_]): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] = 
     ...
     * </pre>
     */
    def theSameElementsInOrderAs(right: GenTraversable[_]): MatcherFactory4[SC, TC1, TC2, TC3, Sequencing] = 
     ...
     * </pre>
     */
    def inOrderOnly(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Sequencing] =
     ...
     * </pre>
     */
    def allOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] =
     ...
     * </pre>
     */
    def allElementsOf(elements: GenTraversable[Any]): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] =
     ...
     * </pre>
     */
    def inOrder(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Sequencing] =
     ...
     * </pre>
     */
    def inOrderElementsOf(elements: GenTraversable[Any]): MatcherFactory4[SC, TC1, TC2, TC3, Sequencing] =
     ...
     * </pre>
     */
    def oneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Containing] =
     ...
     * </pre>
     */
    def oneElementOf(elements: GenTraversable[Any]): MatcherFactory4[SC, TC1, TC2, TC3, Containing] =
     ...
     * </pre>
     */
    def atLeastOneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] =
     ...
     * </pre>
     */
    def atLeastOneElementOf(elements: GenTraversable[Any]): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] =
     ...
     * </pre>
     */
    def only(right: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] = 
     ...
     * </pre>
     */
    def noneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Containing] =
     ...
     * </pre>
     */
    def noElementsOf(elements: GenTraversable[Any]): MatcherFactory4[SC, TC1, TC2, TC3, Containing] =
     ...
     * </pre>
     */
    def atMostOneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] =
     ...
     * </pre>
     */
    def atMostOneElementOf(elements: GenTraversable[Any]): MatcherFactory4[SC, TC1, TC2, TC3, Aggregating] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>file</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory3[SC with AnyRef with U, TC1, TC2, TC3] = and(MatcherWords.be.a(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>validNumber</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = and(MatcherWords.be.a(aMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>apple</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory3[SC with AnyRef with U, TC1, TC2, TC3] = and(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>integerNumber</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = and(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = and(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory3[SC with U, TC1, TC2, TC3] = and(MatcherWords.be.definedAt(right))
  }
  ...
  final class AndFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class AndIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.include.regex(regex))
  }
  ...
  final class AndStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.startWith.regex(regex))
  }
  ...
  final class AndEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = and(MatcherWords.endWith.regex(regex))
  }
  ...
  final class AndNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(o))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>odd</code> is a <a href="BeMatcher.html"><code>BeMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(beMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>directory</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory3[SC with AnyRef with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(bePropertyMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>validMarks</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>invalidMarks</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = macro MatcherFactory3.andNotATypeMatcherFactory3[SC, TC1, TC2, TC3]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = macro MatcherFactory3.andNotAnTypeMatcherFactory3[SC, TC1, TC2, TC3]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.and(MatcherWords.not.be(spread))
  ...
  final class OrHaveWord {
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory4[SC, TC1, TC2, TC3, Length] = or(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory4[SC, TC1, TC2, TC3, Size] = or(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory4[SC, TC1, TC2, TC3, Messaging] = or(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class OrContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory4[SC, TC1, TC2, TC3, Containing] = thisMatcherFactory.or(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory4[SC, TC1, TC2, TC3, KeyMapping] = thisMatcherFactory.or(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory4[SC, TC1, TC2, TC3, ValueMapping] = thisMatcherFactory.or(MatcherWords.contain.value(expectedValue))
...
()
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory3[SC with AnyRef with U, TC1, TC2, TC3] = or(MatcherWords.be.a(bePropertyMatcher))
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = or(MatcherWords.be.a(aMatcher))
...
()
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory3[SC with AnyRef with U, TC1, TC2, TC3] = or(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>integerNumber</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = or(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = or(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory3[SC with U, TC1, TC2, TC3] = or(MatcherWords.be.definedAt(right))
  }
  ...
  final class OrFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class OrIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.include.regex(regex))
  }
  ...
  final class OrStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.startWith.regex(regex))
  }
  ...
  final class OrEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory3[SC with String, TC1, TC2, TC3] = or(MatcherWords.endWith.regex(regex))
  }
  ...
  final class OrNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(o))
...
()
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(beMatcher))
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory3[SC with AnyRef with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(bePropertyMatcher))
...
()
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
...
()
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAnWordApplication: ResultOfAnWordToBePropertyMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))

    /**
     * This method enables the following syntax given a <code>MatcherFactory3</code>, where <code>invalidMarks</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     * aMatcherFactory and not be an (invalidMarks)
     *                         ^
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = macro MatcherFactory3.orNotATypeMatcherFactory3[SC, TC1, TC2, TC3]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = macro MatcherFactory3.orNotAnTypeMatcherFactory3[SC, TC1, TC2, TC3]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory3[SC with AnyRef, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory3[SC with U, TC1, TC2, TC3] = thisMatcherFactory.or(MatcherWords.not.be(spread))
...
/**
 * Companion object containing an implicit method that converts a <code>MatcherFactory3</code> to a <code>Matcher</code>.
 *
 * @author Bill Venners
 */
object MatcherFactory3 {
  ...
  /**
   * Converts a <code>MatcherFactory3</code> to a <code>Matcher</code>.
   *
   * @param matcherFactory a MatcherFactory3 to convert
   * @return a Matcher produced by the passed MatcherFactory3
   */
  implicit def produceMatcher[SC, TC1[_], TC2[_], TC3[_], T <: SC : TC1 : TC2 : TC3](matcherFactory: MatcherFactory3[SC, TC1, TC2, TC3]): Matcher[T] =
   ...
   */
  def andNotATypeMatcherFactory3[SC, TC1[_], TC2[_], TC3[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] =
    new MatcherFactory3Macro[SC, TC1, TC2, TC3].andNotATypeMatcherFactory3(context)(aType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotATypeMatcherFactory3[SC, TC1[_], TC2[_], TC3[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] =
    new MatcherFactory3Macro[SC, TC1, TC2, TC3].orNotATypeMatcherFactory3(context)(aType)

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory3[SC, TC1[_], TC2[_], TC3[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] =
    new MatcherFactory3Macro[SC, TC1, TC2, TC3].andNotAnTypeMatcherFactory3(context)(anType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory3[SC, TC1[_], TC2[_], TC3[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] =
    new MatcherFactory3Macro[SC, TC1, TC2, TC3].orNotAnTypeMatcherFactory3(context)(anType)
}

private[scalatest] class MatcherFactory3Macro[-SC, TC1[_], TC2[_], TC3[_]] {

  import scala.reflect.macros.Context

  def andNotATypeMatcherFactory3(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] = {
  ...
  def orNotATypeMatcherFactory3(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] = {
    import context.universe._
  ...
  def andNotAnTypeMatcherFactory3(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] = {
    import context.universe._
  ...
  def orNotAnTypeMatcherFactory3(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory3[SC with AnyRef, TC1, TC2, TC3]] = {
    import context.universe._
