...
final class ResultOfATypeInvocation[T](val clazzTag: ClassTag[T]) {
   ...
   *
   * <pre class="stHighlighted">
   * a [<span class="stType">RuntimeException</span>] should not
   *                      ^
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * a [<span class="stType">RuntimeException</span>] shouldBe thrownBy { ... }
   *                      ^
   * </pre>
   **/
  // SKIP-DOTTY-START 
   ...
   *
   * <pre class="stHighlighted">
   * a [<span class="stType">IllegalArgumentException</span>] should (be thrownBy { ... })
   *                              ^
   * </pre>
   **/
  // SKIP-DOTTY-START 
   ...
   *
   * <pre class="stHighlighted">
   * a [<span class="stType">RuntimeException</span>] must not
   *                      ^
   * </pre>
   *
   * This method is here to direct people trying to use the above syntax to use <code>noException</code> instead.
   ...
   *
   * <pre class="stHighlighted">
   * a [<span class="stType">RuntimeException</span>] mustBe thrownBy { ... }
   *                      ^
   * </pre>
   **/
  // SKIP-DOTTY-START 
   ...
   *
   * <pre class="stHighlighted">
   * a [<span class="stType">IllegalArgumentException</span>] must (be thrownBy { ... })
   *                              ^
   * </pre>
   **/
  // SKIP-DOTTY-START 
