...
trait LoneElement {
   ...
   *
   * <pre class="stHighlighted">
   * trav.loneElement should be &gt; <span class="stLiteral">9</span>
   * </pre>
   *
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * map.loneElement._1 should be &gt; <span class="stLiteral">9</span>
    * </pre>
    *
   ...
   *
   * <pre class="stHighlighted">
   * jmap.loneElement.getKey should be &gt; <span class="stLiteral">9</span>
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stQuotedString">"9"</span>.loneElement should be (<span class="stQuotedString">'9'</span>)
   * </pre>
   *
