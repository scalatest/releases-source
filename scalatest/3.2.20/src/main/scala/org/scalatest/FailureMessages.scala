...
def cannotLoadDiscoveredSuite(prettifier: org.scalactic.Prettifier, param0: Any, param1: Any): String = Resources.cannotLoadDiscoveredSuite(prettifier.apply(param0), prettifier.apply(param1))
...
def unableToSerializePayload(prettifier: org.scalactic.Prettifier, param0: Any, param1: Any): String = Resources.unableToSerializePayload(prettifier.apply(param0), prettifier.apply(param1))

def unableToSerializeThrowable(prettifier: org.scalactic.Prettifier, param0: Any, param1: Any): String = Resources.unableToSerializeThrowable(prettifier.apply(param0), prettifier.apply(param1))

def unableToReadSerializedEvent: String = Resources.unableToReadSerializedEvent

def unableToContinueRun: String = Resources.unableToContinueRun
