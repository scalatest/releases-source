 ...
 * <span class="stReserved">val</span> option: <span class="stType">Option[Int]</span> = <span class="stType">Some</span>(<span class="stLiteral">7</span>)
 * option should contain (<span class="stLiteral">7</span>)
 * option should contain oneOf (<span class="stLiteral">6</span>, <span class="stLiteral">7</span>, <span class="stLiteral">8</span>)
 * option should contain noneOf (<span class="stLiteral">3</span>, <span class="stLiteral">4</span>, <span class="stLiteral">5</span>)
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stLineComment">// Could never succeed, so does not compile</span>
 * option should contain allOf (<span class="stLiteral">6</span>, <span class="stLiteral">7</span>, <span class="stLiteral">8</span>)
 * </pre>
 * 
 * <p>
...
trait JavaContainingImplicits extends ContainingImpls {
  ...
  /**
    ...
    * (javaList should contain oneOf (<span class="stQuotedString">"HI"</span>)) (after being lowerCased)
    * </pre>
    *
...
trait ContainingStandardImplicits extends JavaContainingImplicits {
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * (<span class="stType">List</span>(<span class="stQuotedString">"hi"</span>) should contain oneOf (<span class="stQuotedString">"HI"</span>)) (after being lowerCased)
    * </pre>
    *
    * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * (<span class="stType">Some</span>(<span class="stQuotedString">"hi"</span>) should contain oneOf (<span class="stQuotedString">"HI"</span>)) (after being lowerCased)
    * </pre>
    *
    * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * (<span class="stType">Array</span>(<span class="stQuotedString">"hi"</span>) should contain oneOf (<span class="stQuotedString">"HI"</span>)) (after being lowerCased)
    * </pre>
    *
    * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
  ...
  /**
    ...
    * (<span class="stQuotedString">"hi hello"</span> should contain oneOf (<span class="stQuotedString">'E'</span>)) (after being lowerCased)
    * </pre>
    *
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * (<span class="stType">Every</span>(<span class="stQuotedString">"hi"</span>, <span class="stQuotedString">"he"</span>, <span class="stQuotedString">"ho"</span>) should contain oneOf (<span class="stQuotedString">"HI"</span>)) (after being lowerCased)
    * </pre>
    *
    * <code>(after being lowerCased)</code> will returns an <a href="../../scalactic/Equality.html"><code>Equality[String]</code></a>
