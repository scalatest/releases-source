...
trait ParallelTestExecution extends OneInstancePerTest { this: Suite =>
   ...
   *   <span class="stReserved">class</span> <span class="stType">InnerSuite</span> <span class="stReserved">extends</span> <span class="stType">Suite</span> <span class="stReserved">with</span> <span class="stType">ParallelTestExecution</span> {
  ...
  //SCALATESTJS,NATIVE-ONLY override def newInstance: Suite with ParallelTestExecution
