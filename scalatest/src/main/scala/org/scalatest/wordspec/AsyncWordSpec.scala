 ...
 * using a style consistent with traditional <code>AnyWordSpec</code> tests.
 *
 ...
 *
 * <p>
 * Here's an example <code>AsyncWordSpec</code>:
 * </p>
 *
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">AddSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> {
 ...
 *
 * <p>
 * &ldquo;<code>it</code>&rdquo; is a method, defined in <code>AsyncWordSpec</code>, which will be invoked
 ...
 * In short, you structure an <code>AsyncWordSpec</code> exactly like a <code>AnyWordSpec</code>, but with
 * tests having result type <code>Assertion</code> or <code>Future[Assertion]</code>. For more examples
 * of structure, see the documentation for <a href="AnyWordSpec.html"><code>AnyWordSpec</code></a>.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * An <code>AsyncWordSpec</code>'s lifecycle has two phases: the <em>registration</em> phase and the
 * <em>ready</em> phase. It starts in registration phase and enters ready phase the first time
 * <code>run</code> is called on it. It then remains in ready phase for the remainder of its lifetime.
 * </p>
 *
 * <p>
 * Tests can only be registered with the <code>it</code> method while the <code>AsyncWordSpec</code> is
 ...
 *
 * <p>
 * By default (unless you mix in <code>ParallelTestExecution</code>), tests in an <code>AsyncWordSpec</code> will be executed one after
 ...
 *
 * <p>
 * If you run this <code>AsyncWordSpec</code> from the interpreter, you will see the following output:
 * </p>
 *
 * <pre class="stREPL">
 ...
 *
 * <p>
 * Here's an example <code>AsyncWordSpec</code> that uses <code>markup</code>:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> {
 * <br/>  <span class="stQuotedString">"A mutable Set"</span> should {
 *     <span class="stQuotedString">"allow an element to be added"</span> in {
 ...
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> scala.concurrent.Future
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> {
 ...
 *     }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> <span class="stReserved">with</span> <span class="stType">BeforeAndAfter</span> {
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
 * <br/>  <span class="stQuotedString">"Testing"</span> should {
 *     <span class="stQuotedString">"be easy"</span> in {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example2Spec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example3Spec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 * <pre class="stHighlighted">
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">trait</span> <span class="stType">AsyncWordSpecStackBehaviors</span> { <span class="stReserved">this</span>: <span class="stType">wordspec.AsyncWordSpec</span> =&gt;
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">StackSpec</span> <span class="stReserved">extends</span> <span class="stType">wordspec.AsyncWordSpec</span> <span class="stReserved">with</span> <span class="stType">AsyncWordSpecStackBehaviors</span> {
