 ...
 * <span class="stQuotedString">"A Stack (when empty)"</span> will <span class="stQuotedString">"be empty"</span> in { ... }
 *                        ^
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stQuotedString">"A Stack (with one item)"</span> will behave like nonEmptyStack(stackWithOneItem, lastValuePushed)
 *                           ^
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stQuotedString">"A Stack (when empty)"</span> will { ...
 *                        ^
 * </pre>
 *
 * <p>
 ...
 * <br/><span class="stQuotedString">"The ScalaTest Matchers DSL"</span> will provide {
 *                              ^
 * </pre>
 *
 * <p>
