...
trait AsyncFreeSpecLike extends AsyncTestSuite with AsyncTestRegistration with Informing with Notifying with Alerting with Documenting { thisSuite =>
  ...
  // SKIP-DOTTY-END
  //DOTTY-ONLY inline final def registerAsyncTest(testText: String, testTags: Tag*)(testFun: => Future[compatible.Assertion])(implicit pos: source.Position): Unit = {
  ...
  // SKIP-DOTTY-END
  //DOTTY-ONLY inline final def registerIgnoredAsyncTest(testText: String, testTags: Tag*)(testFun: => Future[compatible.Assertion])(implicit pos: source.Position): Unit = {
   ...
   * this <code>AsyncFreeSpec</code> instance.
   *
   ...
   * the <code>Set</code> of tags for the test. If this <code>AsyncFreeSpec</code> contains no tags, this method returns an empty <code>Map</code>.
   *
   * <p>
  ...
  /**
   * Run zero to many of this <code>AsyncFreeSpec</code>'s tests.
   *
   * <p>
  ...
  /**
   * An immutable <code>Set</code> of test names. If this <code>AsyncFreeSpec</code> contains no tests, this method returns an
   * empty <code>Set</code>.
   *
   * <p>
   ...
   * example itself, with all components separated by a space. For example, consider this <code>AsyncFreeSpec</code>:
   * </p>
   *
   * <pre class="stHighlighted">
   ...
   *
   * <p>
   * Invoking <code>testNames</code> on this <code>AsyncFreeSpec</code> will yield a set that contains the following
  ...
  /**
   * Supports shared test registration in <code>AsyncFreeSpec</code>s.
   *
   * <p>
