...
trait FixtureAnyFlatSpecLike extends org.scalatest.FixtureTestSuite with org.scalatest.FixtureTestRegistration with ShouldVerb with MustVerb with CanVerb with Informing with Notifying with Alerting with Documenting { thisSuite =>
  ...
  protected final class TheyVerbStringTaggedAs(verb: String, name: String, tags: List[Tag]) {
     ...
     *
     * <pre class="stHighlighted">
     * they must <span class="stQuotedString">"pop values in last-in-first-out order"</span> taggedAs(<span class="stType">SlowTest</span>) in { fixture => ... }
     *                                                                      ^
     * </pre>
     *
     * <p>
     ...
     *
     * <pre class="stHighlighted">
     * they must <span class="stQuotedString">"pop values in last-in-first-out order"</span> taggedAs(<span class="stType">SlowTest</span>) ignore { fixture => ... }
     *                                                                      ^
     * </pre>
     *
     * <p>
   ...
   * type passed to <code>in</code> differs in a <code>AnyFlatSpec</code> and a <code>org.scalatest.flatspec.FixtureAnyFlatSpec</code>.
   * A <code>org.scalatest.flatspec.FixtureAnyFlatSpec</code> needs two <code>in</code> methods, one that takes a no-arg
   ...
   * <code>AnyFlatSpec</code> and <code>org.scalatest.flatspec.FixtureAnyFlatSpec</code> each provide an implicit conversion
