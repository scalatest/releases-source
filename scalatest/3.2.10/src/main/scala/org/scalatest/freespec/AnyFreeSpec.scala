 ...
 * Because it gives absolute freedom (and no guidance) on how specification text should be written, <code>AnyFreeSpec</code> is a good choice for teams experienced 
 * with BDD and able to agree on how to structure the specification text.
 * </td></tr></table>
 * 
 * <p>
 * Here's an example <code>AnyFreeSpec</code>:
 * </p>
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.freespec
 * <br/><span class="stReserved">import</span> org.scalatest.freespec.AnyFreeSpec
 ...
 *
 * <p>
 * In a <code>AnyFreeSpec</code> you write a test with a string followed by <code>in</code> and the body of the
 ...
 *
 * <p>
 * A <code>AnyFreeSpec</code> can also be used to write a specification-style test in languages other than English. For
 * example:
 * </p>
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">import</span> org.scalatest.freespec.AnyFreeSpec
 * <br/><span class="stReserved">class</span> <span class="stType">ComputerRoomRulesSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFreeSpec</span> {
 ...
 *
 * <p>
 * A <code>AnyFreeSpec</code>'s lifecycle has two phases: the <em>registration</em> phase and the
 ...
 * good intention of resurrecting the test at a later time, <code>AnyFreeSpec</code> adds a method
 ...
 * <span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFreeSpec</span> {
 * <br/>  <span class="stQuotedString">"A Set"</span> - {
 *     <span class="stQuotedString">"when empty"</span> - {
 *       <span class="stQuotedString">"should have size 0"</span> in {
 *         assert(Set.empty.size === <span class="stLiteral">0</span>)
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">freespec.AnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 *
 * <p>
 * If you run this <code>AnyFreeSpec</code> from the interpreter, you will see the following output:
 * </p>
 *
 * <pre class="stREPL">
 * scala&gt; org.scalatest.run(new SetSpec)
 ...
 *
 * <p>
 * Here's an example <code>AnyFreeSpec</code> that uses <code>markup</code>:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">freespec.AnyFreeSpec</span> {
 * <br/>  <span class="stQuotedString">"A mutable Set"</span> - {
 *     <span class="stQuotedString">"should allow an element to be added"</span> in {
 ...
 * You can mark tests as pending in a <code>AnyFreeSpec</code> like this:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 * that used the <code>GivenWhenThen</code> trait. For example, the following snippet in a <code>AnyFreeSpec</code>:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 *
 * A <code>AnyFreeSpec</code>'s tests may be classified into groups by <em>tagging</em> them with string names.
 * As with any suite, when executing a <code>AnyFreeSpec</code>, groups of tests can
 ...
 * create a matching tag for <code>AnyFreeSpec</code>s like this:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 *
 * <p>
 * Given these definitions, you could tag <code>AnyFreeSpec</code> tests like this:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFreeSpec</span> {
 ...
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">freespec.AnyFreeSpec</span> {
 ...
 *
 * <p>
 * If all or most tests need the same fixture, you can avoid some of the boilerplate of the loan-fixture method approach by using a <code>FixtureAnyFreeSpec</code>
 * and overriding <code>withFixture(OneArgTest)</code>.
 * Each test in a <code>FixtureAnyFreeSpec</code> takes a fixture as a parameter, allowing you to pass the fixture into
 ...
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> java.io._
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">freespec.FixtureAnyFreeSpec</span> {
 ...
 * the objects.  For more information on the <code>withFixture(OneArgTest)</code> technique, see the <a href="FixtureAnyFreeSpec.html">documentation for <code>FixtureAnyFreeSpec</code></a>.
 * </p>
 *
 ...
 * <span class="stReserved">import</span> collection.mutable.ListBuffer
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">BeforeAndAfter</span> {
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">freespec.AnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
 * <br/>  <span class="stQuotedString">"Testing"</span> - {
 *     <span class="stQuotedString">"should be easy"</span> in {
 *       builder.append(<span class="stQuotedString">"easy!"</span>)
 *       assert(builder.toString === <span class="stQuotedString">"ScalaTest is easy!"</span>)
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example2Spec</span> <span class="stReserved">extends</span> <span class="stType">freespec.AnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example3Spec</span> <span class="stReserved">extends</span> <span class="stType">freespec.AnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 * by different fixture objects.  To accomplish this in a <code>AnyFreeSpec</code>, you first place shared tests in <em>behavior functions</em>.
 * These behavior functions will be invoked during the construction phase of any <code>AnyFreeSpec</code> that uses them, so that the tests they
 * contain will be registered as tests in that <code>AnyFreeSpec</code>.  For example, given this stack class:
 * </p>
 *
 * <pre class="stHighlighted">
 ...
 * stack fixture to use when running the tests. So in your <code>AnyFreeSpec</code> for stack, you'd invoke the
 ...
 * can define a behavior function that encapsulates these shared tests inside the <code>AnyFreeSpec</code> that uses them. If they are shared
 * between different <code>AnyFreeSpec</code>s, however, you could also define them in a separate trait that is mixed into each <code>AnyFreeSpec</code>
 * that uses them.
 * </p>
 *
 * <p>
 ...
 * 
 * <pre class="stHighlighted">
 * <span class="stReserved">trait</span> <span class="stType">StackBehaviors</span> { <span class="stReserved">this</span>: <span class="stType">AnyFreeSpec</span> =&gt;
 ...
 *
 * <p>
 * Given these behavior functions, you could invoke them directly, but <code>AnyFreeSpec</code> offers a DSL for the purpose,
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">SharedTestExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">AnyFreeSpec</span> <span class="stReserved">with</span> <span class="stType">StackBehaviors</span> {
 ...
 * complaining that multiple tests are being registered with the same test name. A good way to solve this problem in a <code>AnyFreeSpec</code> is to make sure
 ...
 * For example, the following code in a <code>AnyFreeSpec</code> would register a test with the name <code>"A Stack when empty should be empty"</code>:
 * </p>
 *
 * <pre class="stHighlighted">
 * <span class="stQuotedString">"A Stack"</span> - {
