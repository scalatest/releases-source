 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">TestCanceled</span>(ordinal, userFriendlyName, suiteName, <span class="stType">Some</span>(thisSuite.getClass.getName), testName))
 * </pre>
 *
 * <p>
 * The suite class name parameter is optional, because suites in ScalaTest are an abstraction that
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">InfoProvided</span>(ordinal, message, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, suiteId, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">AlertProvided</span>(ordinal, message, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, suiteId, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">NoteProvided</span>(ordinal, message, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, suiteId, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">MarkupProvided</span>(ordinal, text, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, suiteId, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">ScopeOpened</span>(ordinal, message, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, suiteId, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">ScopeClosed</span>(ordinal, message, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, suiteId, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * report(<span class="stType">ScopePending</span>(ordinal, message, <span class="stType">Some</span>(<span class="stType">NameInfo</span>(suiteName, <span class="stType">Some</span>(thisSuite.getClass.getName), <span class="stType">Some</span>(testName)))))
 * </pre>
 *
 * <p>
