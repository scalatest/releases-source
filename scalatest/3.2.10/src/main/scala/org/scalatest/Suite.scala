 ...
 * <span class="stReserved">package</span> org.scalatest.examples.suite.info
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">Suite</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 * <br/>  <span class="stReserved">def</span> <span class="literalIdentifier">&#96;test: an element can be added to an empty mutable Set&#96;</span> {
 * <br/>    given(<span class="stQuotedString">"an empty mutable Set"</span>)
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.suite.matchers
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">Suite</span> <span class="stReserved">with</span> <span class="stType">Matchers</span> {
 * <br/>  <span class="stReserved">def</span> <span class="literalIdentifier">&#96;test: an empty Set should have size 0&#96;</span> {
 *     Set.empty.size should equal (<span class="stLiteral">0</span>)
 *   }
 * <br/>  <span class="stReserved">def</span> <span class="literalIdentifier">&#96;test: invoking head on an empty Set should produce NoSuchElementException&#96;</span> {
 *     a [<span class="stType">NoSuchElementException</span>] should be thrownBy { Set.empty.head }
 *   }
 * }
 * </pre>
 * 
