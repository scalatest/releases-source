...
final class BeWord {
   ...
   *
   * <pre class="stHighlighted">
   * sevenDotOh should be (<span class="stLiteral">7.1</span> +- <span class="stLiteral">0.2</span>)
   *                      ^
   * </pre>
   **/
   ...
   *
   * <pre class="stHighlighted">
   * a[<span class="stType">Exception</span>] should (be thrownBy { <span class="stQuotedString">"hi"</span>.charAt(-<span class="stLiteral">1</span>) })
   *                         ^
   * </pre>
   **/
