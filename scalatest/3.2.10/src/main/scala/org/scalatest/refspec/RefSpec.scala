 ...
 * <span class="stReserved">package</span> org.scalatest.examples.spec
 * <br/><span class="stReserved">import</span> org.scalatest.RefSpec
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">object</span> <span class="literalIdentifier">&#96;Set&#96;</span> { <span class="stLineComment">// Not discovered, because no space character</span>
 * }
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">object</span> <span class="literalIdentifier">&#96;Set &#96;</span> { <span class="stLineComment">// Discovered, because of the trailing space character</span>
 * }
 * </pre>
 *
 * <p>
 ...
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;A Set&#96;</span> {
 *     <span class="stReserved">object</span> <span class="literalIdentifier">&#96;when empty&#96;</span> {
 *       @<span class="stType">Ignore</span> <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should have size 0&#96;</span> {
 *         assert(Set.empty.size === <span class="stLiteral">0</span>)
 *       }
 * <br/>      <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should produce NoSuchElementException when head is invoked&#96;</span> {
 *         assertThrows[<span class="stType">NoSuchElementException</span>] {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.ignoreall
 * <br/><span class="stReserved">import</span> org.scalatest._
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.info
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;A mutable Set&#96;</span> {
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should allow an element to be added&#96;</span> {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.markup
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 * <span class="stQuotedString"></span>
 *   <span class="stQuotedString">"""</span> }
 * <br/>  <span class="stReserved">object</span> `A mutable <span class="stType">Set</span>` {
 *     <span class="stReserved">def</span> `should allow an element to be added` {
 *       <span class="stType">Given</span>(<span class="stQuotedString">"an empty mutable Set"</span>)
 *       <span class="stReserved">val</span> set = mutable.Set.empty[<span class="stType">String</span>]
 * <br/>      <span class="stType">When</span>(<span class="stQuotedString">"an element is added"</span>)
 *       set += <span class="stQuotedString">"clarity"</span>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.note
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> {
 * <br/>  <span class="stReserved">object</span> `A mutable <span class="stType">Set</span>` {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.pending
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> {
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;A Set&#96;</span> {
 *     <span class="stReserved">object</span> <span class="literalIdentifier">&#96;when empty&#96;</span> {
 *       <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should have size 0&#96;</span> { pending }
 * <br/>      <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should produce NoSuchElementException when head is invoked&#96;</span> {
 *         assertThrows[<span class="stType">NoSuchElementException</span>] {
 *           Set.empty.head
 *         }
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.tagging
 * <br/><span class="stReserved">import</span> org.scalatest.RefSpec
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> {
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;A Set&#96;</span> {
 *     <span class="stReserved">object</span> <span class="literalIdentifier">&#96;when empty&#96;</span> {
 * <br/>      @<span class="stType">SlowTest</span>
 *       <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should have size 0&#96;</span> {
 *         assert(Set.empty.size === <span class="stLiteral">0</span>)
 *       }
 * <br/>      @<span class="stType">SlowTest</span> @<span class="stType">DbTest</span>
 *       <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should produce NoSuchElementException when head is invoked&#96;</span> {
 *         assertThrows[<span class="stType">NoSuchElementException</span>] {
 *           Set.empty.head
 *         }
 *       }
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.getfixture
 * <br/><span class="stReserved">import</span> org.scalatest.RefSpec
 * <span class="stReserved">import</span> collection.mutable.ListBuffer
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> {
 ...
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;Testing &#96;</span> {
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should be easy&#96;</span> {
 ...
 *     }
 * <br/>    <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should be fun&#96;</span> {
 *       <span class="stReserved">val</span> f = fixture
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.fixturecontext
 ...
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should be productive&#96;</span> {
 ...
 *     }
 *   }
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;Test code&#96;</span> {
 *     <span class="stLineComment">// This test needs the ListBuffer[String] fixture</span>
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should be readable&#96;</span> {
 ...
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should be clear and concise&#96;</span> {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.noargtest
 ...
 *     }
 *   }
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;This test&#96;</span> {
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should succeed&#96;</span> {
 *       assert(<span class="stLiteral">1</span> + <span class="stLiteral">1</span> === <span class="stLiteral">2</span>)
 *     }
 * <br/>    <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should fail&#96;</span> {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.loanfixture
 ...
 * 
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.beforeandafter
 * <br/><span class="stReserved">import</span> org.scalatest.RefSpec
 * <span class="stReserved">import</span> org.scalatest.BeforeAndAfter
 * <span class="stReserved">import</span> collection.mutable.ListBuffer
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> <span class="stReserved">with</span> <span class="stType">BeforeAndAfter</span> {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.composingwithfixture
 * <br/><span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> collection.mutable.ListBuffer
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
 * <br/>  <span class="stReserved">object</span> <span class="literalIdentifier">&#96;Testing &#96;</span> {
 *     <span class="stReserved">def</span> <span class="literalIdentifier">&#96;should be easy&#96;</span> {
 *       builder.append(<span class="stQuotedString">"easy!"</span>)
 *       assert(builder.toString === <span class="stQuotedString">"ScalaTest is easy!"</span>)
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example2Spec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">Example3Spec</span> <span class="stReserved">extends</span> <span class="stType">RefSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">package</span> org.scalatest.examples.spec.composingbeforeandaftereach
 * <br/><span class="stReserved">import</span> org.scalatest._
