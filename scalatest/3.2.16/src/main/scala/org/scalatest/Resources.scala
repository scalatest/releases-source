...
def cannotLoadDiscoveredSuite(param0: Any, param1: Any): String = makeString("cannotLoadDiscoveredSuite", Array(param0, param1))
...
def flexmarkClassNotFound: String = resourceBundle.getString("flexmarkClassNotFound")

def rawFlexmarkClassNotFound: String = resourceBundle.getString("flexmarkClassNotFound")

def unableToSerializePayload(param0: Any, param1: Any): String = makeString("unableToSerializePayload", Array(param0, param1))

def rawUnableToSerializePayload: String = resourceBundle.getString("unableToSerializePayload")

def unableToSerializeThrowable(param0: Any, param1: Any): String = makeString("unableToSerializeThrowable", Array(param0, param1))

def rawUnableToSerializeThrowable: String = resourceBundle.getString("unableToSerializeThrowable")

def unableToReadSerializedEvent: String = resourceBundle.getString("unableToReadSerializedEvent")

def rawUnableToReadSerializedEvent: String = resourceBundle.getString("unableToReadSerializedEvent")

def unableToContinueRun: String = resourceBundle.getString("unableToContinueRun")

def rawUnableToContinueRun: String = resourceBundle.getString("unableToContinueRun")
