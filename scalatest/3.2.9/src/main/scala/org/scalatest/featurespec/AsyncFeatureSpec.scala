 ...
 * to write non-blocking asynchronous tests that are consistent with their traditional <code>AnyFeatureSpec</code> tests.
 * <em>Note: <code>AsyncFeatureSpec</code> is intended for use in special situations where non-blocking asynchronous
 * testing is needed, with class <code>AnyFeatureSpec</code> used for general needs.</em>
 * </td></tr></table>
 * 
 * <p>
 ...
 *     }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">TVSetActorSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AsyncFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 *
 * <p>
 * By default (unless you mix in <code>ParallelTestExecution</code>), tests in an <code>AsyncFeatureSpec</code> will be executed one after
 ...
 * <br/><span class="stReserved">import</span> org.scalatest.featurespec.AsyncFeatureSpec
 * <span class="stReserved">import</span> scala.concurrent.Future
 ...
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"The add methods"</span>) {
 ...
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"addNow will immediately compute a sum of passed Ints"</span>) {
 ...
 *   <span class="stReserved">def</span> addNow(addends: <span class="stType">Int</span>*): <span class="stType">Int</span> = addends.sum
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"The add methods"</span>) {
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"addSoon will eventually compute a sum of passed Ints"</span>) {
 *       <span class="stReserved">val</span> futureSum: <span class="stType">Future[Int]</span> = addSoon(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
 *       <span class="stLineComment">// You can map assertions onto a Future, then return</span>
 *       <span class="stLineComment">// the resulting Future[Assertion] to ScalaTest:</span>
 *       futureSum map { sum =&gt; assert(sum == <span class="stLiteral">3</span>) }
 ...
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AsyncFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
 ...
 * <br/><span class="stReserved">import</span> collection.mutable
 * <span class="stReserved">import</span> org.scalatest._
 * <br/><span class="stReserved">class</span> <span class="stType">SetSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AsyncFeatureSpec</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"An element can be added to an empty mutable Set"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"When an element is added to an empty mutable Set"</span>) {
 ...
 *   <span class="stReserved">def</span> addNow(addends: <span class="stType">Int</span>*): <span class="stType">Int</span> = addends.sum
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"The add methods"</span>) {
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"addSoon will eventually compute a sum of passed Ints"</span>) (pending)
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"addNow will immediately compute a sum of passed Ints"</span>) {
 *       <span class="stReserved">val</span> sum: <span class="stType">Int</span> = addNow(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
 *       <span class="stLineComment">// You can also write synchronous tests. The body</span>
 *       <span class="stLineComment">// must have result type Assertion:</span>
 ...
 *
 * <p>
 * Given these definitions, you could place <code>AsyncFeatureSpec</code> tests into groups with tags like this:
 * </p>
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">import</span> org.scalatest.featurespec.AsyncFeatureSpec
 ...
 * <span class="stReserved">import</span> org.scalatest._
 * <span class="stReserved">import</span> scala.concurrent.Future
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AsyncFeatureSpec</span> {
 ...
 *   }
 * <br/>  <span class="stReserved">def</span> addSoon(addends: <span class="stType">Int</span>*): <span class="stType">Future[Int]</span> = <span class="stType">Future</span> { addends.sum }
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"addSoon"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"succeed case"</span>) {
 *       addSoon(<span class="stLiteral">1</span>, <span class="stLiteral">1</span>) map { sum =&gt; assert(sum == <span class="stLiteral">2</span>) }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"fail case"</span>) {
 ...
 *     }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.FixtureAsyncFeatureSpec</span> {
 ...
 *   }
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 *     <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to read test code written by others"</span>) { actor =&gt;
 *       actor ! <span class="stType">Append</span>(<span class="stQuotedString">"encourage clear code!"</span>)
 *       <span class="stReserved">val</span> futureString = actor ? <span class="stType">GetValue</span>
 *       futureString map { s =&gt;
 *         assert(s === <span class="stQuotedString">"ScalaTest is designed to encourage clear code!"</span>)
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to understand what the tests are doing"</span>) { actor =&gt;
 ...
 * the <a href="FixtureAsyncFeatureSpec.html">documentation for <code>FixtureAsyncFeatureSpec</code></a>.
 * </p>
 *
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.AsyncFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to read test code written by others"</span>) {
 *       builderActor ! <span class="stType">Append</span>(<span class="stQuotedString">"encourage clear code!"</span>)
 *       <span class="stReserved">val</span> futureString = builderActor ? <span class="stType">GetValue</span>
 *       <span class="stReserved">val</span> futureList = bufferActor ? <span class="stType">GetValue</span>
 *       <span class="stReserved">val</span> futurePair: <span class="stType">Future[(String, List[String])]</span> = futureString zip futureList
 ...
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Size is fired at non-empty stack actor: "</span> + name) {
 ...
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Peek is fired at non-empty stack actor: "</span> + name) {
 *       <span class="stReserved">val</span> stackActor = createNonEmptyStackActor
 ...
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Pop is fired at non-empty stack actor: "</span> + name) {
 *       <span class="stReserved">val</span> stackActor = createNonEmptyStackActor
 *       <span class="stReserved">val</span> futurePair: <span class="stType">Future[(StackInfo[Int], StackInfo[Int])]</span> =
 *         <span class="stReserved">for</span> {
 ...
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Size is fired at non-full stack actor: "</span> + name) {
 ...
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Push is fired at non-full stack actor: "</span> + name) {
 *       <span class="stReserved">val</span> stackActor = createNonFullStackActor
 *       <span class="stReserved">val</span> futurePair: <span class="stType">Future[(StackInfo[Int], StackInfo[Int])]</span> =
 *         <span class="stReserved">for</span> {
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">ScenariosFor</span>(nonEmptyStackActor(almostEmptyStackActor, <span class="stType">LastValuePushed</span>, almostEmptyStackActorName))
 * <span class="stType">ScenariosFor</span>(nonFullStackActor(almostEmptyStackActor, almostEmptyStackActorName))
 * </pre>
 *
 * <p>
 * Here's an example:
 ...
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Size is fired at empty stack actor"</span>) {
 ...
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Peek is fired at empty stack actor"</span>) {
 *       recoverToSucceededIf[<span class="stType">IllegalStateException</span>] {
 *         emptyStackActor ? <span class="stType">Peek</span>
 *       }
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"Pop is fired at empty stack actor"</span>) {
 *       recoverToSucceededIf[<span class="stType">IllegalStateException</span>] {
 *         emptyStackActor ? <span class="stType">Pop</span>
 *       }
 *     }
 * <br/>    <span class="stType">ScenariosFor</span>(nonEmptyStackActor(almostEmptyStackActor, <span class="stType">LastValuePushed</span>, almostEmptyStackActorName))
 *     <span class="stType">ScenariosFor</span>(nonFullStackActor(almostEmptyStackActor, almostEmptyStackActorName))
 * <br/>    <span class="stType">ScenariosFor</span>(nonEmptyStackActor(almostFullStackActor, <span class="stType">LastValuePushed</span>, almostFullStackActorName))
 *     <span class="stType">ScenariosFor</span>(nonFullStackActor(almostFullStackActor, almostFullStackActorName))
 ...
 *       }
 *     }
 * <br/>    <span class="stType">ScenariosFor</span>(nonEmptyStackActor(fullStackActor, <span class="stType">LastValuePushed</span>, fullStackActorName))
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">ScenariosFor</span>(nonEmptyStack(almostFullStackActor, lastValuePushed, almostFullStackActorName))
 * </pre>
 *
 * <p>
