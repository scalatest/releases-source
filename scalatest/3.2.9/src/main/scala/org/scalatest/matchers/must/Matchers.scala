...
*/
  ...
  // SKIP-DOTTY-END
    ...
    // SKIP-DOTTY-END
    //DOTTY-ONLY extension (inline leftSideString: String)(using pos: source.Position, prettifier: Prettifier) transparent inline def must(compileWord: CompileWord): Assertion = ${ org.scalatest.matchers.must.CompileMacro.mustCompileImpl('{leftSideString}, '{typeChecks(leftSideString)}, '{compileWord})('{pos}) }
