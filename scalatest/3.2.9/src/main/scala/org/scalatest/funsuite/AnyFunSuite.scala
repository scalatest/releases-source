...
/**
  ...
  * <br/><span class="stReserved">import</span> org.scalatest.funsuite.AnyFunSuite
  ...
  * <span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">AnyFunSuite</span> {
  * <br/>  test(<span class="stQuotedString">"An empty Set should have size 0"</span>) {
  *     assert(Set.empty.size === <span class="stLiteral">0</span>)
  *   }
  * <br/>  test(<span class="stQuotedString">"Invoking head on an empty Set should produce NoSuchElementException"</span>) {
  ...
  * <br/><span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">GivenWhenThen</span> {
  ...
  * <br/><span class="stReserved">import</span> collection.mutable
  * <span class="stReserved">import</span> org.scalatest._
  * <br/><span class="stReserved">class</span> <span class="stType">SetSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AnyFunSuite</span> {
  * <br/>  test(<span class="stQuotedString">"An element can be added to an empty mutable Set"</span>) {
  ...
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">AnyFunSuite</span> {
  ...
  * <span class="stReserved">import</span> org.scalatest._
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AnyFunSuite</span> {
  ...
  * <span class="stReserved">import</span> java.io._
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.FixtureAnyFunSuite</span> {
  ...
  * <span class="stReserved">import</span> collection.mutable.ListBuffer
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">AnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">BeforeAndAfter</span> {
  ...
  *   }
  * }
  * <br/><span class="stReserved">class</span> <span class="stType">ExampleSuite</span> <span class="stReserved">extends</span> <span class="stType">funsuite.AnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">Builder</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> {
  * <br/>  test(<span class="stQuotedString">"Testing should be easy"</span>) {
  *     builder.append(<span class="stQuotedString">"easy!"</span>)
  *     assert(builder.toString === <span class="stQuotedString">"ScalaTest is easy!"</span>)
  *     assert(buffer.isEmpty)
  ...
  *
  * <pre class="stHighlighted">
  * <span class="stReserved">class</span> <span class="stType">Example2Suite</span> <span class="stReserved">extends</span> <span class="stType">AnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">Buffer</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
  * </pre>
  *
  * <p>
  ...
  *
  * <pre class="stHighlighted">
  * <span class="stReserved">class</span> <span class="stType">Example3Suite</span> <span class="stReserved">extends</span> <span class="stType">AnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">Builder</span>
  * </pre>
  *
  * <p>
  ...
  * <pre class="stHighlighted">
  * <span class="stReserved">import</span> org.scalatest.funsuite.AnyFunSuite
  * <br/><span class="stReserved">trait</span> <span class="stType">FunSuiteStackBehaviors</span> { <span class="stReserved">this</span>: <span class="stType">AnyFunSuite</span> =&gt;
  ...
  * <pre class="stHighlighted">
  * <span class="stReserved">import</span> org.scalatest.funsuite.AnyFunSuite
  * <br/><span class="stReserved">class</span> <span class="stType">StackFunSuite</span> <span class="stReserved">extends</span> <span class="stType">AnyFunSuite</span> <span class="stReserved">with</span> <span class="stType">FunSuiteStackBehaviors</span> {
