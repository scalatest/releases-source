 ...
 * <br/>  <span class="stReserved">override</span> <span class="stReserved">def</span> setUp(): <span class="stType">Unit</span> = {
 ...
 *   }
 * <br/>  <span class="stReserved">def</span> testEasy(): <span class="stType">Unit</span> = { <span class="stLineComment">// Uses JUnit-style assertions</span>
 ...
 *   }
 * <br/>  <span class="stReserved">def</span> testFun(): <span class="stType">Unit</span> = { <span class="stLineComment">// Uses ScalaTest assertions</span>
 ...
 * 
 * <pre class="stHighlighted">
 * <span class="stReserved">def</span> testGoodIdea(): <span class="stType">Unit</span> = { <span class="stLineComment">// result type will be Unit</span>
