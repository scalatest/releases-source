...
/**
 * An <code>AnyVal</code> for finite non-zero <code>Double</code>s.
 *
 * <p>
 * Note: a <code>NonZeroFiniteDouble</code> may not equal 0.0.
 * </p>
 *
 * <p>
 * Because <code>NonZeroFiniteDouble</code> is an <code>AnyVal</code> it
 * will usually be as efficient as an <code>Double</code>, being
 * boxed only when a <code>Double</code> would have been boxed.
 * </p>
 *
 * <p>
 * The <code>NonZeroFiniteDouble.apply</code> factory method is
 ...
 *
 * <p>
 * <code>NonZeroFiniteDouble.apply</code> cannot be used if the value
 ...
 * method, <code>NonZeroFiniteDouble.from</code>, instead:
 * </p>
 *
 * <pre class="stREPL">
 * scala&gt; val x = 1.1
 ...
 *
 * <p>
 * The <code>NonZeroFiniteDouble.from</code> factory method will inspect
 ...
 *
 * <p>
 * The <code>NonZeroFiniteDouble.apply</code> factory method is marked
 ...
 * <code>NonZeroFiniteDouble.apply</code> explicitly. Here's an example:
 * </p>
 *
 * <pre class="stREPL">
 ...
 * </p>
 *
 * @param value The <code>Double</code> value underlying this <code>NonZeroFiniteDouble</code>.
 */
final class NonZeroFiniteDouble private (val value: Double) extends AnyVal {

  /**
   * A string representation of this <code>NonZeroFiniteDouble</code>.
   */
  override def toString: String = s"NonZeroFiniteDouble(${value.toString()})"

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to a <code>Byte</code>.
   */
  def toByte: Byte = value.toByte

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to a <code>Short</code>.
   */
  def toShort: Short = value.toShort

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to a <code>Char</code>.
   */
  def toChar: Char = value.toChar

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to an <code>Int</code>.
   */
  def toInt: Int = value.toInt

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to a <code>Long</code>.
   */
  def toLong: Long = value.toLong

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to a <code>Float</code>.
   */
  def toFloat: Float = value.toFloat

  /**
   * Converts this <code>NonZeroFiniteDouble</code> to a <code>Double</code>.
   */
  def toDouble: Double = value.toDouble

  /** Returns this value, unmodified. */
  def unary_+ : NonZeroFiniteDouble = this
  /** Returns the negation of this value. */
  def unary_- : NonZeroFiniteDouble = NonZeroFiniteDouble.ensuringValid(-value)

  /**
   * Converts this <code>NonZeroFiniteDouble</code>'s value to a string then concatenates the given string.
   */
   ...
   */
  def max(that: NonZeroFiniteDouble): NonZeroFiniteDouble = if (math.max(value, that.value) == value) this else that

  /**
   * Returns <code>this</code> if <code>this &lt; that</code> or <code>that</code> otherwise.
   */
  def min(that: NonZeroFiniteDouble): NonZeroFiniteDouble = if (math.min(value, that.value) == value) this else that

  /**
   * Indicates whether this `NonZeroFiniteDouble` has a value that is a whole number: it is finite and it has no fraction part.
   */
  def isWhole = {
   ...
   * value, and if the result is positive, returns the result wrapped in a <code>NonZeroFiniteDouble</code>,
   * else throws <code>AssertionError</code>.
   *
   * <p>
   * This method will inspect the result of applying the given function to this
   * <code>NonZeroFiniteDouble</code>'s underlying <code>Double</code> value and if the result
   * is greater than <code>0.0</code>, it will return a <code>NonZeroFiniteDouble</code> representing that value.
   ...
   * the computation represented by applying the given function to this <code>NonZeroFiniteDouble</code>'s
   ...
   * </p>
   *
   * @param f the <code>Double =&gt; Double</code> function to apply to this <code>NonZeroFiniteDouble</code>'s
   *     underlying <code>Double</code> value.
   * @return the result of applying this <code>NonZeroFiniteDouble</code>'s underlying <code>Double</code> value to
   *     to the passed function, wrapped in a <code>NonZeroFiniteDouble</code> if it is positive (else throws <code>AssertionError</code>).
   * @throws AssertionError if the result of applying this <code>NonZeroFiniteDouble</code>'s underlying <code>Double</code> value to
  ...
  def ensuringValid(f: Double => Double): NonZeroFiniteDouble = {
    ...
    if (NonZeroFiniteDoubleMacro.isValid(candidateResult)) new NonZeroFiniteDouble(candidateResult)
    else throw new AssertionError(s"${candidateResult.toString()}, the result of applying the passed function to ${value.toString()}, was not a valid NonZeroFiniteDouble")
  }

}

/**
 * The companion object for <code>NonZeroFiniteDouble</code> that offers
 ...
 * for <code>NonZeroFiniteDouble</code>.
 */
object NonZeroFiniteDouble {

  /**
   * The largest value representable as a finite non-zero <code>Double</code>,
   * which is <code>NonZeroFiniteDouble(1.7976931348623157E308)</code>.
   */
  final val MaxValue: NonZeroFiniteDouble = NonZeroFiniteDouble.ensuringValid(Double.MaxValue)

  /**
   * The smallest value representable as a finite non-zero
   * <code>Double</code>, which is <code>NonZeroFiniteDouble(-1.7976931348623157E308)</code>.
   */
  final val MinValue: NonZeroFiniteDouble = NonZeroFiniteDouble.ensuringValid(Double.MinValue) // Can't use the macro here

  /**
   * A factory method that produces an <code>Option[NonZeroFiniteDouble]</code> given a
   * <code>Double</code> value.
   *
   * <p>
   * This method will inspect the passed <code>Double</code> value and if
   * it is a finite non-zero <code>Double</code>, it will return a <code>NonZeroFiniteDouble</code>
   ...
   * </p>
   *
   * @param value the <code>Double</code> to inspect, and if finite non-zero, return
   *     wrapped in a <code>Some[NonZeroFiniteDouble]</code>.
   * @return the specified <code>Double</code> value wrapped in a
   *     <code>Some[NonZeroFiniteDouble]</code>, if it is NonZeroFiniteDouble, else
   *     <code>None</code>.
   */
  def from(value: Double): Option[NonZeroFiniteDouble] =
    if (NonZeroFiniteDoubleMacro.isValid(value)) Some(new NonZeroFiniteDouble(value)) else None

  /**
   * A factory/assertion method that produces a <code>NonZeroFiniteDouble</code> given a
   ...
   * This method will inspect the passed <code>Double</code> value and if
   * it is a finite non-zero <code>Double</code>, it will return a <code>NonZeroFiniteDouble</code>
   * representing that value. Otherwise, the passed <code>Double</code> value is not finite non-zero,
   ...
   * call in that you get something you didn't already have if the assertion
   * succeeds: a <em>type</em> that promises a <code>Double</code> is finite non-zero.
   * </p>
   *
   * @param value the <code>Double</code> to inspect, and if finite non-zero, return
   *     wrapped in a <code>NonZeroFiniteDouble</code>.
   * @return the specified <code>Double</code> value wrapped in a
   *     <code>NonZeroFiniteDouble</code>, if it is finite non-zero, else
   *     throws <code>AssertionError</code>.
   * @throws AssertionError if the passed value is not finite non-zero
   */
  def ensuringValid(value: Double): NonZeroFiniteDouble =
    if (NonZeroFiniteDoubleMacro.isValid(value)) new NonZeroFiniteDouble(value) else {
      throw new AssertionError(s"${value.toString()} was not a valid NonZeroFiniteDouble")
    }
   ...
   * it is a finite non-zero <code>Float</code>, it will return a <code>NonZeroFiniteDouble</code>
   ...
   *     wrapped in a <code>Success(NonZeroFiniteDouble)</code>.
   * @return the specified <code>Float</code> value wrapped
   *     in a <code>Success(NonZeroFiniteDouble)</code>, if it is finite non-zero, else a <code>Failure(AssertionError)</code>.
   */
  def tryingValid(value: Double): Try[NonZeroFiniteDouble] =
    if (NonZeroFiniteDoubleMacro.isValid(value))
      Success(new NonZeroFiniteDouble(value))
    else
      Failure(new AssertionError(s"${value.toString()} was not a valid NonZeroFiniteDouble"))
   ...
   * <p>
   * This method will inspect the passed <code>Double</code> value and if
   * it is a finite non-zero <code>Double</code>, it will return a <code>Pass</code>.
   * Otherwise, the passed <code>Double</code> value is finite non-zero, so this
   ...
   * </p>
   *
   * @param value the `Int` to validate that it is finite non-zero.
   * @return a `Pass` if the specified `Int` value is finite non-zero,
   *   else a `Fail` containing an error value produced by passing the
   *   specified `Double` to the given function `f`.
   */
  def passOrElse[E](value: Double)(f: Double => E): Validation[E] =
    if (NonZeroFiniteDoubleMacro.isValid(value)) Pass else Fail(f(value))
   ...
   * Otherwise, the passed <code>Double</code> value is not finite non-zero, so this
   ...
   *
   * @param value the <code>Double</code> to inspect, and if finite non-zero, return
   *     wrapped in a <code>Good(NonZeroFiniteDouble)</code>.
   * @return the specified <code>Double</code> value wrapped
   *     in a <code>Good(NonZeroFiniteDouble)</code>, if it is finite non-zero, else a <code>Bad(f(value))</code>.
   */
  def goodOrElse[B](value: Double)(f: Double => B): NonZeroFiniteDouble Or B =
    if (NonZeroFiniteDoubleMacro.isValid(value)) Good(NonZeroFiniteDouble.ensuringValid(value)) else Bad(f(value))
   ...
   *
   * @param value the <code>Double</code> to inspect, and if finite non-zero, return
   *     wrapped in a <code>Right(NonZeroFiniteDouble)</code>.
   * @return the specified <code>Double</code> value wrapped
   *     in a <code>Right(NonZeroFiniteDouble)</code>, if it is finite non-zero, else a <code>Left(f(value))</code>.
   */
  def rightOrElse[L](value: Double)(f: Double => L): Either[L, NonZeroFiniteDouble] =
    if (NonZeroFiniteDoubleMacro.isValid(value)) Right(NonZeroFiniteDouble.ensuringValid(value)) else Left(f(value))

  /**
   * A predicate method that returns true if a given
   * <code>Double</code> value is finite non-zero.
   *
   * @param value the <code>Double</code> to inspect, and if finite non-zero, return true.
   * @return true if the specified <code>Double</code> is positive, else false.
   */
  def isValid(value: Double): Boolean = NonZeroFiniteDoubleMacro.isValid(value)

  /**
   * A factory method that produces a <code>NonZeroFiniteDouble</code> given a
   * <code>Double</code> value and a default <code>NonZeroFiniteDouble</code>.
   *
   * <p>
   * This method will inspect the passed <code>Double</code> value and if
   * it is a finite non-zero <code>Double</code>, it will return a <code>NonZeroFiniteDouble</code>
   * representing that value.  Otherwise, the passed <code>Double</code> value is finite non-zero,
   ...
   *
   * @param value the <code>Double</code> to inspect, and if finite non-zero, return.
   * @param default the <code>NonZeroFiniteDouble</code> to return if the passed
   *     <code>Double</code> value is not finite non-zero.
   * @return the specified <code>Double</code> value wrapped in a
   *     <code>NonZeroFiniteDouble</code>, if it is finite non-zero, else the
   *     <code>default</code> <code>NonZeroFiniteDouble</code> value.
   */
  def fromOrElse(value: Double, default: => NonZeroFiniteDouble): NonZeroFiniteDouble =
    if (NonZeroFiniteDoubleMacro.isValid(value)) new NonZeroFiniteDouble(value) else default
   ...
   * <code>NonZeroFiniteDouble</code> if passed a valid <code>Double</code>
   * literal, otherwise a compile time error.
   *
   * <p>
   * The macro that implements this method will inspect the
   * specified <code>Double</code> expression at compile time. If
   * the expression is a finite non-zero <code>Double</code> literal,
   * it will return a <code>NonZeroFiniteDouble</code> representing that value.
   ...
   *     wrapped in a <code>NonZeroFiniteDouble</code> at run time.
   * @return the specified, valid <code>Double</code> literal
   *     value wrapped in a <code>NonZeroFiniteDouble</code>. (If the
   *     specified expression is not a valid <code>Double</code>
   *     literal, the invocation of this method will not
   *     compile.)
   */
  implicit def apply(value: Double): NonZeroFiniteDouble = macro NonZeroFiniteDoubleMacro.apply

  /**
   * Implicit widening conversion from <code>NonZeroFiniteDouble</code> to
   * <code>Double</code>.
   *
   * @param pos the <code>NonZeroFiniteDouble</code> to widen
   * @return the <code>Double</code> value underlying the specified
   *     <code>NonZeroFiniteDouble</code>
   */
  implicit def widenToDouble(pos: NonZeroFiniteDouble): Double = pos.value


  /**
   * Implicit widening conversion from <code>NonZeroFiniteDouble</code> to <code>NonZeroDouble</code>.
   *
   * @param pos the <code>NonZeroFiniteDouble</code> to widen
   * @return the <code>Double</code> value underlying the specified <code>NonZeroFiniteDouble</code>,
   *     widened to <code>Double</code> and wrapped in a <code>NonZeroDouble</code>.
   */
  implicit def widenToNonZeroDouble(pos: NonZeroFiniteDouble): NonZeroDouble = NonZeroDouble.ensuringValid(pos.value)


  /**
   * Implicit Ordering instance.
   */
  implicit val ordering: Ordering[NonZeroFiniteDouble] =
    new Ordering[NonZeroFiniteDouble] {
      def compare(x: NonZeroFiniteDouble, y: NonZeroFiniteDouble): Int = x.toDouble.compare(y.toDouble)
    }


  /**
   * The smallest positive value greater than 0.0d representable as a <code>NonZeroFiniteDouble</code>, which is NonZeroFiniteDouble(4.9E-324).
   */
  final val MinPositiveValue: NonZeroFiniteDouble = NonZeroFiniteDouble.ensuringValid(Double.MinPositiveValue)
