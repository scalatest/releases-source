 ...
 *
 * <p>
 * Because <code>PosZDouble</code> is an <code>AnyVal</code> it
 ...
 *
 * <p>
 * The <code>PosZDouble.apply</code> factory method is marked
 ...
 * <code>PosZDouble.apply</code> explicitly. Here's an example:
 * </p>
 *
 * <pre class="stREPL">
...
final class PosZDouble private (val value: Double) extends AnyVal {
   ...
   */
  override def toString: String = s"PosZDouble(${value.toString()})"
  ...
  def unary_- : NegZDouble = NegZDouble.ensuringValid(-value)
   ...
   * is greater than <code>0.0</code>, it will return a <code>PosZDouble</code> representing that value.
   ...
   *     to the passed function, wrapped in a <code>PosZDouble</code> if it is positive (else throws <code>AssertionError</code>).
   ...
   */
  def ceil: PosZDouble = PosZDouble.ensuringValid(math.ceil(value).toDouble)
  ...
  /**
   * True if this <code>PosZDouble</code> value represents positive infinity, else false.
   */
...
object PosZDouble {
   ...
   * <code>Double</code>, which is <code>PosZDouble(0.0)</code>.
   */
   ...
   * it is a non-negative <code>Double</code>, it will return a <code>PosZDouble</code>
   ...
   * </p>
   *
   * @param value the <code>Double</code> to inspect, and if non-negative, return
   *     wrapped in a <code>Some[PosZDouble]</code>.
   * @return the specified <code>Double</code> value wrapped in a
   *     <code>Some[PosZDouble]</code>, if it is PosZDouble, else
   *     <code>None</code>.
   */
  ...
  /**
   * A factory/assertion method that produces a <code>PosZDouble</code> given a
   ...
   * This method will inspect the passed <code>Double</code> value and if
   * it is a non-negative <code>Double</code>, it will return a <code>PosZDouble</code>
   * representing that value. Otherwise, the passed <code>Double</code> value is not non-negative,
   ...
   * call in that you get something you didn't already have if the assertion
   * succeeds: a <em>type</em> that promises a <code>Double</code> is non-negative.
   * </p>
   *
   * @param value the <code>Double</code> to inspect, and if non-negative, return
   *     wrapped in a <code>PosZDouble</code>.
   * @return the specified <code>Double</code> value wrapped in a
   *     <code>PosZDouble</code>, if it is non-negative, else
  ...
  def ensuringValid(value: Double): PosZDouble =
    if (PosZDoubleMacro.isValid(value)) new PosZDouble(value) else {
      throw new AssertionError(s"${value.toString()} was not a valid PosZDouble")
    }
   ...
   * it is a non-negative <code>Float</code>, it will return a <code>PosZDouble</code>
   ...
   *     in a <code>Success(PosZDouble)</code>, if it is non-negative, else a <code>Failure(AssertionError)</code>.
   */
  def tryingValid(value: Double): Try[PosZDouble] =
    if (PosZDoubleMacro.isValid(value))
      Success(new PosZDouble(value))
    else
      Failure(new AssertionError(s"${value.toString()} was not a valid PosZDouble"))
   ...
   * <p>
   * This method will inspect the passed <code>Double</code> value and if
   * it is a non-negative <code>Double</code>, it will return a <code>Pass</code>.
   * Otherwise, the passed <code>Double</code> value is non-negative, so this
  ...
  def passOrElse[E](value: Double)(f: Double => E): Validation[E] =
    if (PosZDoubleMacro.isValid(value)) Pass else Fail(f(value))
   ...
   * Otherwise, the passed <code>Double</code> value is not non-negative, so this
   ...
   *     in a <code>Good(PosZDouble)</code>, if it is non-negative, else a <code>Bad(f(value))</code>.
   */
  def goodOrElse[B](value: Double)(f: Double => B): PosZDouble Or B =
    if (PosZDoubleMacro.isValid(value)) Good(PosZDouble.ensuringValid(value)) else Bad(f(value))
   ...
   * @return the specified <code>Double</code> value wrapped
   *     in a <code>Right(PosZDouble)</code>, if it is non-negative, else a <code>Left(f(value))</code>.
   */
  def rightOrElse[L](value: Double)(f: Double => L): Either[L, PosZDouble] =
    if (PosZDoubleMacro.isValid(value)) Right(PosZDouble.ensuringValid(value)) else Left(f(value))

  /**
   * A predicate method that returns true if a given
   * <code>Double</code> value is non-negative.
   *
   * @param value the <code>Double</code> to inspect, and if non-negative, return true.
   ...
   * This method will inspect the passed <code>Double</code> value and if
   * it is a non-negative <code>Double</code>, it will return a <code>PosZDouble</code>
   * representing that value.  Otherwise, the passed <code>Double</code> value is non-negative,
   ...
   *     <code>Double</code> value is not non-negative.
   * @return the specified <code>Double</code> value wrapped in a
   *     <code>PosZDouble</code>, if it is non-negative, else the
   ...
   * it will return a <code>PosZDouble</code> representing that value.
   ...
   *     wrapped in a <code>PosZDouble</code> at run time.
   ...
   */
  implicit def widenToDouble(pos: PosZDouble): Double = pos.value
  ...
  implicit val ordering: Ordering[PosZDouble] =
    new Ordering[PosZDouble] {
      def compare(x: PosZDouble, y: PosZDouble): Int = x.toDouble.compare(y.toDouble)
    }
  ...
  /**
   * The smallest positive value greater than 0.0d representable as a <code>PosZDouble</code>, which is PosZDouble(4.9E-324).
   */
  final val MinPositiveValue: PosZDouble = PosZDouble.ensuringValid(Double.MinPositiveValue)

  /**
   * <strong>The formerly implicit <code>posZDoubleOrd</code> field has been deprecated and will be removed in a future version of ScalaTest. Please use the <code>ordering</code> field instead.</strong>
   */
  @deprecated("The formerly implicit posZDoubleOrd field has been deprecated and will be removed in a future version of ScalaTest. Please use the ordering field instead.")
  val posZDoubleOrd: Ordering[PosZDouble] =
    new Ordering[PosZDouble] {
      def compare(x: PosZDouble, y: PosZDouble): Int = ordering.compare(x, y)
    }
