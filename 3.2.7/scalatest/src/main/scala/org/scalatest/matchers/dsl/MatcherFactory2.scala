...
abstract class MatcherFactory2[-SC, TC1[_], TC2[_]] { thisMatcherFactory =>
   ...
   */
  def and[U <: SC](rightMatcher: Matcher[U]): MatcherFactory2[U, TC1, TC2] =
   ...
   */
  def or[U <: SC](rightMatcher: Matcher[U]): MatcherFactory2[U, TC1, TC2] =
    new MatcherFactory2[U, TC1, TC2] {
      def matcher[V <: U : TC1 : TC2]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def and[U <: SC](rightMatcherFactory: MatcherFactory1[U, TC2]): MatcherFactory2[U, TC1, TC2] =
    new MatcherFactory2[U, TC1, TC2] {
      def matcher[V <: U : TC1 : TC2]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def or[U <: SC](rightMatcherFactory: MatcherFactory1[U, TC2]): MatcherFactory2[U, TC1, TC2] =
    new MatcherFactory2[U, TC1, TC2] {
      def matcher[V <: U : TC1 : TC2]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def and[U <: SC, TC3[_]](rightMatcherFactory: MatcherFactory1[U, TC3]): MatcherFactory3[U, TC1, TC2, TC3] =
   ...
   */
  def or[U <: SC, TC3[_]](rightMatcherFactory: MatcherFactory1[U, TC3]): MatcherFactory3[U, TC1, TC2, TC3] =
    new MatcherFactory3[U, TC1, TC2, TC3] {
      def matcher[V <: U : TC1 : TC2 : TC3]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC3[_], TC4[_]](rightMatcherFactory: MatcherFactory2[U, TC3, TC4]): MatcherFactory4[U, TC1, TC2, TC3, TC4] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC3[_], TC4[_]](rightMatcherFactory: MatcherFactory2[U, TC3, TC4]): MatcherFactory4[U, TC1, TC2, TC3, TC4] =
    new MatcherFactory4[U, TC1, TC2, TC3, TC4] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC3[_], TC4[_], TC5[_]](rightMatcherFactory: MatcherFactory3[U, TC3, TC4, TC5]): MatcherFactory5[U, TC1, TC2, TC3, TC4, TC5] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC3[_], TC4[_], TC5[_]](rightMatcherFactory: MatcherFactory3[U, TC3, TC4, TC5]): MatcherFactory5[U, TC1, TC2, TC3, TC4, TC5] =
    new MatcherFactory5[U, TC1, TC2, TC3, TC4, TC5] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_]](rightMatcherFactory: MatcherFactory4[U, TC3, TC4, TC5, TC6]): MatcherFactory6[U, TC1, TC2, TC3, TC4, TC5, TC6] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_]](rightMatcherFactory: MatcherFactory4[U, TC3, TC4, TC5, TC6]): MatcherFactory6[U, TC1, TC2, TC3, TC4, TC5, TC6] =
    new MatcherFactory6[U, TC1, TC2, TC3, TC4, TC5, TC6] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]](rightMatcherFactory: MatcherFactory5[U, TC3, TC4, TC5, TC6, TC7]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]](rightMatcherFactory: MatcherFactory5[U, TC3, TC4, TC5, TC6, TC7]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
    new MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_], TC7[_], TC8[_]](rightMatcherFactory: MatcherFactory6[U, TC3, TC4, TC5, TC6, TC7, TC8]): MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_], TC7[_], TC8[_]](rightMatcherFactory: MatcherFactory6[U, TC3, TC4, TC5, TC6, TC7, TC8]): MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] =
    new MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7 : TC8]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_], TC7[_], TC8[_], TC9[_]](rightMatcherFactory: MatcherFactory7[U, TC3, TC4, TC5, TC6, TC7, TC8, TC9]): MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC3[_], TC4[_], TC5[_], TC6[_], TC7[_], TC8[_], TC9[_]](rightMatcherFactory: MatcherFactory7[U, TC3, TC4, TC5, TC6, TC7, TC8, TC9]): MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] =
    new MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7 : TC8 : TC9]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
  ...
  final class AndHaveWord {
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>:
     *
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory3[SC, TC1, TC2, Length] = and(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory3[SC, TC1, TC2, Size] = and(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory3[SC, TC1, TC2, Messaging] = and(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class AndContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory3[SC, TC1, TC2, KeyMapping] = thisMatcherFactory.and(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory3[SC, TC1, TC2, ValueMapping] = thisMatcherFactory.and(MatcherWords.contain.value(expectedValue))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>file</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory2[SC with AnyRef with U, TC1, TC2] = and(MatcherWords.be.a(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>validNumber</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory2[SC with U, TC1, TC2] = and(MatcherWords.be.a(aMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>apple</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory2[SC with AnyRef with U, TC1, TC2] = and(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>integerNumber</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory2[SC with U, TC1, TC2] = and(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory2[SC with AnyRef, TC1, TC2] = and(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory2[SC with U, TC1, TC2] = and(MatcherWords.be.definedAt(right))
  }
  ...
  final class AndFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class AndIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.include.regex(regex))
  }
  ...
  final class AndStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.startWith.regex(regex))
  }
  ...
  final class AndEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = and(MatcherWords.endWith.regex(regex))
  }
  ...
  final class AndNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def have[U](firstPropertyMatcher: HavePropertyMatcher[U, _], propertyMatchers: HavePropertyMatcher[U, _]*): MatcherFactory2[SC with U, TC1, TC2] =
     ...
     * </pre>
     */
    def be[U](resultOfLessThanComparison: ResultOfLessThanComparison[U]): MatcherFactory2[SC with U, TC1, TC2] =
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(o))
     ...
     * </pre>
     */
    def be[U](resultOfGreaterThanComparison: ResultOfGreaterThanComparison[U]): MatcherFactory2[SC with U, TC1, TC2] =
     ...
     * </pre>
     */
    def be[U](resultOfLessThanOrEqualToComparison: ResultOfLessThanOrEqualToComparison[U]): MatcherFactory2[SC with U, TC1, TC2] =
     ...
     * </pre>
     */
    def be[U](resultOfGreaterThanOrEqualToComparison: ResultOfGreaterThanOrEqualToComparison[U]): MatcherFactory2[SC with U, TC1, TC2] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>odd</code> is a <a href="BeMatcher.html"><code>BeMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(beMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>directory</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory2[SC with AnyRef with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(bePropertyMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>validMarks</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>invalidMarks</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = macro MatcherFactory2.andNotATypeMatcherFactory2[SC, TC1, TC2]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = macro MatcherFactory2.andNotAnTypeMatcherFactory2[SC, TC1, TC2]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(spread))
     ...
     * </pre>
     */
    def be[A, U <: PartialFunction[A, _]](resultOfDefinedAt: ResultOfDefinedAt[A]): MatcherFactory2[SC with U, TC1, TC2] = 
     ...
     * </pre>
     */
    def fullyMatch(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def include(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def include(expectedSubstring: String): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def startWith(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def startWith(expectedSubstring: String): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def endWith(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def endWith(expectedSubstring: String): MatcherFactory2[SC with String, TC1, TC2] =
     ...
     * </pre>
     */
    def contain(right: ResultOfTheSameElementsInOrderAsApplication): MatcherFactory3[SC, TC1, TC2, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
   ...
   * </pre>
   */
  def and(existWord: ExistWord): MatcherFactory3[SC, TC1, TC2, Existence] = 
   ...
   * </pre>
   */
  def and(notExist: ResultOfNotExist): MatcherFactory3[SC, TC1, TC2, Existence] = 
  ...
  final class OrHaveWord {
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory3[SC, TC1, TC2, Length] = or(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory3[SC, TC1, TC2, Size] = or(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory3[SC, TC1, TC2, Messaging] = or(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class OrContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory3[SC, TC1, TC2, KeyMapping] = thisMatcherFactory.or(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory3[SC, TC1, TC2, ValueMapping] = thisMatcherFactory.or(MatcherWords.contain.value(expectedValue))
...
()
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory2[SC with AnyRef with U, TC1, TC2] = or(MatcherWords.be.a(bePropertyMatcher))
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory2[SC with U, TC1, TC2] = or(MatcherWords.be.a(aMatcher))
...
()
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory2[SC with AnyRef with U, TC1, TC2] = or(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>integerNumber</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory2[SC with U, TC1, TC2] = or(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory2[SC with AnyRef, TC1, TC2] = or(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory2[SC with U, TC1, TC2] = or(MatcherWords.be.definedAt(right))
  }
  ...
  final class OrFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class OrIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.include.regex(regex))
  }
  ...
  final class OrStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.startWith.regex(regex))
  }
  ...
  final class OrEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory2[SC with String, TC1, TC2] = or(MatcherWords.endWith.regex(regex))
  }
  ...
  final class OrNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(o))
...
()
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(beMatcher))
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory2[SC with AnyRef with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(bePropertyMatcher))
...
()
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
...
()
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAnWordApplication: ResultOfAnWordToBePropertyMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))

    /**
     * This method enables the following syntax given a <code>MatcherFactory2</code>, where <code>invalidMarks</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     * aMatcherFactory and not be an (invalidMarks)
     *                         ^
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = macro MatcherFactory2.orNotATypeMatcherFactory2[SC, TC1, TC2]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = macro MatcherFactory2.orNotAnTypeMatcherFactory2[SC, TC1, TC2]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory2[SC with U, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(spread))
   ...
   * </pre>
   */
  def or(existWord: ExistWord): MatcherFactory3[SC, TC1, TC2, Existence] = 
   ...
   * </pre>
   */
  def or(notExist: ResultOfNotExist): MatcherFactory3[SC, TC1, TC2, Existence] = 
    thisMatcherFactory.or(MatcherWords.not.exist)
}

/**
 * Companion object containing an implicit method that converts a <code>MatcherFactory2</code> to a <code>Matcher</code>.
 *
 * @author Bill Venners
 */
object MatcherFactory2 {
  ...
  /**
   * Converts a <code>MatcherFactory2</code> to a <code>Matcher</code>.
   *
   ...
   */
  def andNotATypeMatcherFactory2[SC, TC1[_], TC2[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] =
    new MatcherFactory2Macro[SC, TC1, TC2].andNotATypeMatcherFactory2(context)(aType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotATypeMatcherFactory2[SC, TC1[_], TC2[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] =
    new MatcherFactory2Macro[SC, TC1, TC2].orNotATypeMatcherFactory2(context)(aType)

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory2[SC, TC1[_], TC2[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] =
    new MatcherFactory2Macro[SC, TC1, TC2].andNotAnTypeMatcherFactory2(context)(anType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory2[SC, TC1[_], TC2[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] =
    new MatcherFactory2Macro[SC, TC1, TC2].orNotAnTypeMatcherFactory2(context)(anType)
}

private[scalatest] class MatcherFactory2Macro[-SC, TC1[_], TC2[_]] {

  import scala.reflect.macros.Context

  def andNotATypeMatcherFactory2(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] = {
  ...
  def orNotATypeMatcherFactory2(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] = {
    import context.universe._
  ...
  def andNotAnTypeMatcherFactory2(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] = {
    import context.universe._
  ...
  def orNotAnTypeMatcherFactory2(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory2[SC with AnyRef, TC1, TC2]] = {
    import context.universe._
