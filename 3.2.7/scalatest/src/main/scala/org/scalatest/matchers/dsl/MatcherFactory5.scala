...
abstract class MatcherFactory5[-SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_]] { thisMatcherFactory =>
  ...
  final class AndHaveWord {
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>:
     *
  ...
  final class AndContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def allElementsOf(elements: GenTraversable[Any]): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Aggregating] =
     ...
     * </pre>
     */
    def inOrderElementsOf(elements: GenTraversable[Any]): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Sequencing] =
     ...
     * </pre>
     */
    def oneElementOf(elements: GenTraversable[Any]): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Containing] =
     ...
     * </pre>
     */
    def atLeastOneElementOf(elements: GenTraversable[Any]): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Aggregating] =
     ...
     * </pre>
     */
    def noElementsOf(elements: GenTraversable[Any]): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Containing] =
     ...
     * </pre>
     */
    def atMostOneElementOf(elements: GenTraversable[Any]): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Aggregating] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>file</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>validNumber</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>apple</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>integerNumber</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>odd</code> is a <a href="BeMatcher.html"><code>BeMatcher</code></a>:
     *
     * <pre class="stHighlighted">
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>directory</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>validMarks</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>invalidMarks</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5] = macro MatcherFactory5.andNotATypeMatcherFactory5[SC, TC1, TC2, TC3, TC4, TC5]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5] = macro MatcherFactory5.andNotAnTypeMatcherFactory5[SC, TC1, TC2, TC3, TC4, TC5]
     ...
     * </pre>
     */
    def contain(right: ResultOfOneElementOfApplication): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtLeastOneElementOfApplication): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfNoElementsOfApplication): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAllElementsOfApplication): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderElementsOfApplication): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtMostOneElementOfApplication): MatcherFactory6[SC, TC1, TC2, TC3, TC4, TC5, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>integerNumber</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory5</code>, where <code>invalidMarks</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     * aMatcherFactory and not be an (invalidMarks)
     *                         ^
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5] = macro MatcherFactory5.orNotATypeMatcherFactory5[SC, TC1, TC2, TC3, TC4, TC5]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5] = macro MatcherFactory5.orNotAnTypeMatcherFactory5[SC, TC1, TC2, TC3, TC4, TC5]
...
/**
 * Companion object containing an implicit method that converts a <code>MatcherFactory5</code> to a <code>Matcher</code>.
 *
 * @author Bill Venners
 */
object MatcherFactory5 {
  ...
  /**
   * Converts a <code>MatcherFactory5</code> to a <code>Matcher</code>.
   *
   ...
   */
  def andNotATypeMatcherFactory5[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] =
    new MatcherFactory5Macro[SC, TC1, TC2, TC3, TC4, TC5].andNotATypeMatcherFactory5(context)(aType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotATypeMatcherFactory5[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] =
    new MatcherFactory5Macro[SC, TC1, TC2, TC3, TC4, TC5].orNotATypeMatcherFactory5(context)(aType)

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory5[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] =
    new MatcherFactory5Macro[SC, TC1, TC2, TC3, TC4, TC5].andNotAnTypeMatcherFactory5(context)(anType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory5[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] =
    new MatcherFactory5Macro[SC, TC1, TC2, TC3, TC4, TC5].orNotAnTypeMatcherFactory5(context)(anType)
}

private[scalatest] class MatcherFactory5Macro[-SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_]] {

  import scala.reflect.macros.Context

  def andNotATypeMatcherFactory5(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] = {
  ...
  def orNotATypeMatcherFactory5(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] = {
    import context.universe._
  ...
  def andNotAnTypeMatcherFactory5(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] = {
    import context.universe._
  ...
  def orNotAnTypeMatcherFactory5(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory5[SC with AnyRef, TC1, TC2, TC3, TC4, TC5]] = {
    import context.universe._
