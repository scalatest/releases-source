...
abstract class MatcherFactory1[-SC, TC1[_]] { thisMatcherFactory =>
  ...
  final class AndHaveWord {
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory2[SC, TC1, Messaging] = and(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class AndContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory2[SC, TC1, Containing] = thisMatcherFactory.and(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory2[SC, TC1, KeyMapping] = thisMatcherFactory.and(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory2[SC, TC1, ValueMapping] = thisMatcherFactory.and(MatcherWords.contain.value(expectedValue))
     ...
     * </pre>
     */
    def theSameElementsAs(right: GenTraversable[_]): MatcherFactory2[SC, TC1, Aggregating] = 
     ...
     * </pre>
     */
    def theSameElementsInOrderAs(right: GenTraversable[_]): MatcherFactory2[SC, TC1, Sequencing] = 
     ...
     * </pre>
     */
    def inOrderOnly(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Sequencing] =
     ...
     * </pre>
     */
    def allOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Aggregating] =
     ...
     * </pre>
     */
    def allElementsOf(elements: GenTraversable[Any]): MatcherFactory2[SC, TC1, Aggregating] =
     ...
     * </pre>
     */
    def inOrder(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Sequencing] =
     ...
     * </pre>
     */
    def inOrderElementsOf(elements: GenTraversable[Any]): MatcherFactory2[SC, TC1, Sequencing] =
     ...
     * </pre>
     */
    def oneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Containing] =
     ...
     * </pre>
     */
    def oneElementOf(elements: GenTraversable[Any]): MatcherFactory2[SC, TC1, Containing] =
     ...
     * </pre>
     */
    def atLeastOneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Aggregating] =
     ...
     * </pre>
     */
    def atLeastOneElementOf(elements: GenTraversable[Any]): MatcherFactory2[SC, TC1, Aggregating] =
     ...
     * </pre>
     */
    def only(right: Any*): MatcherFactory2[SC, TC1, Aggregating] = 
     ...
     * </pre>
     */
    def noneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Containing] =
     ...
     * </pre>
     */
    def noElementsOf(elements: GenTraversable[Any]): MatcherFactory2[SC, TC1, Containing] =
     ...
     * </pre>
     */
    def atMostOneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory2[SC, TC1, Aggregating] =
     ...
     * </pre>
     */
    def atMostOneElementOf(elements: GenTraversable[Any]): MatcherFactory2[SC, TC1, Aggregating] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>file</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>validNumber</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>apple</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>integerNumber</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory1[SC with U, TC1] = and(MatcherWords.be.definedAt(right))
  }
  ...
  final class AndFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = and(MatcherWords.fullyMatch.regex(regexWithGroups))
  ...
  final class AndIncludeWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = and(MatcherWords.include.regex(regexWithGroups))
  ...
  final class AndStartWithWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = and(MatcherWords.startWith.regex(regexWithGroups))
  ...
  final class AndEndWithWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = and(MatcherWords.endWith.regex(regexWithGroups))
  ...
  final class AndNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory1[SC with U, TC1] = thisMatcherFactory.and(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def have(resultOfMessageWordApplication: ResultOfMessageWordApplication): MatcherFactory2[SC, TC1, Messaging] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>odd</code> is a <a href="BeMatcher.html"><code>BeMatcher</code></a>:
     *
     * <pre class="stHighlighted">
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>directory</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>validMarks</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>invalidMarks</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory1[SC with AnyRef, TC1] = macro MatcherFactory1.andNotATypeMatcherFactory1[SC, TC1]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory1[SC with AnyRef, TC1] = macro MatcherFactory1.andNotAnTypeMatcherFactory1[SC, TC1]
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory1[SC with U, TC1] = thisMatcherFactory.and(MatcherWords.not.be(spread))
     ...
     * </pre>
     */
    def be[A, U <: PartialFunction[A, _]](resultOfDefinedAt: ResultOfDefinedAt[A]): MatcherFactory1[SC with U, TC1] = 
     ...
     * </pre>
     */
    def contain[U](expectedElement: U): MatcherFactory2[SC, TC1, Containing] =
     ...
     * </pre>
     */
    def contain(resultOfKeyWordApplication: ResultOfKeyWordApplication): MatcherFactory2[SC, TC1, KeyMapping] =
     ...
     * </pre>
     */
    def contain(resultOfValueWordApplication: ResultOfValueWordApplication): MatcherFactory2[SC, TC1, ValueMapping] =
     ...
     * </pre>
     */
    def contain(right: ResultOfOneOfApplication): MatcherFactory2[SC, TC1, Containing] =
     ...
     * </pre>
     */
    def contain(right: ResultOfOneElementOfApplication): MatcherFactory2[SC, TC1, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtLeastOneOfApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtLeastOneElementOfApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfNoneOfApplication): MatcherFactory2[SC, TC1, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfNoElementsOfApplication): MatcherFactory2[SC, TC1, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfTheSameElementsAsApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfTheSameElementsInOrderAsApplication): MatcherFactory2[SC, TC1, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfOnlyApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderOnlyApplication): MatcherFactory2[SC, TC1, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAllOfApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAllElementsOfApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderApplication): MatcherFactory2[SC, TC1, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderElementsOfApplication): MatcherFactory2[SC, TC1, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtMostOneOfApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtMostOneElementOfApplication): MatcherFactory2[SC, TC1, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
  ...
  final class OrHaveWord {
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory2[SC, TC1, Messaging] = or(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class OrContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory2[SC, TC1, Containing] = thisMatcherFactory.or(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory2[SC, TC1, KeyMapping] = thisMatcherFactory.or(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory2[SC, TC1, ValueMapping] = thisMatcherFactory.or(MatcherWords.contain.value(expectedValue))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>integerNumber</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory1[SC with U, TC1] = or(MatcherWords.be.definedAt(right))
  }
  ...
  final class OrFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = or(MatcherWords.fullyMatch.regex(regexWithGroups))
  ...
  final class OrIncludeWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = or(MatcherWords.include.regex(regexWithGroups))
  ...
  final class OrStartWithWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = or(MatcherWords.startWith.regex(regexWithGroups))
  ...
  final class OrEndWithWord {
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory1[SC with String, TC1] = or(MatcherWords.endWith.regex(regexWithGroups))
  ...
  final class OrNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory1[SC with U, TC1] = thisMatcherFactory.or(MatcherWords.not.equal(spread))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory1</code>, where <code>invalidMarks</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     * aMatcherFactory and not be an (invalidMarks)
     *                         ^
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory1[SC with AnyRef, TC1] = macro MatcherFactory1.orNotATypeMatcherFactory1[SC, TC1]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory1[SC with AnyRef, TC1] = macro MatcherFactory1.orNotAnTypeMatcherFactory1[SC, TC1]
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory1[SC with U, TC1] = thisMatcherFactory.or(MatcherWords.not.be(spread))
...
/**
 * Companion object containing an implicit method that converts a <code>MatcherFactory1</code> to a <code>Matcher</code>.
 *
 * @author Bill Venners
 */
object MatcherFactory1 {
  ...
  /**
   * Converts a <code>MatcherFactory1</code> to a <code>Matcher</code>.
   *
   * @param matcherFactory a MatcherFactory1 to convert
   * @return a Matcher produced by the passed MatcherFactory1
   */
  implicit def produceMatcher[SC, TC1[_], T <: SC : TC1](matcherFactory: MatcherFactory1[SC, TC1]): Matcher[T] =
   ...
   */
  def andNotATypeMatcherFactory1[SC, TC1[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] =
    new MatcherFactory1Macro[SC, TC1].andNotATypeMatcherFactory1(context)(aType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotATypeMatcherFactory1[SC, TC1[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] =
    new MatcherFactory1Macro[SC, TC1].orNotATypeMatcherFactory1(context)(aType)

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory1[SC, TC1[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] =
    new MatcherFactory1Macro[SC, TC1].andNotAnTypeMatcherFactory1(context)(anType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory1[SC, TC1[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] =
    new MatcherFactory1Macro[SC, TC1].orNotAnTypeMatcherFactory1(context)(anType)
}

private[scalatest] class MatcherFactory1Macro[-SC, TC1[_]] {

  import scala.reflect.macros.Context

  def andNotATypeMatcherFactory1(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] = {
  ...
  def orNotATypeMatcherFactory1(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] = {
    import context.universe._
  ...
  def andNotAnTypeMatcherFactory1(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] = {
    import context.universe._
  ...
  def orNotAnTypeMatcherFactory1(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory1[SC with AnyRef, TC1]] = {
    import context.universe._
