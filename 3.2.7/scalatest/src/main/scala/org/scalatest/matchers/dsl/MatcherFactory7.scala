...
abstract class MatcherFactory7[-SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]] { thisMatcherFactory =>
   ...
   * implicit parameter (for example, a <code>TC1[T]</code>, <code>TC2[T]</code>, <em>etc.</em>).
   */
  def matcher[T <: SC : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7]: Matcher[T]

  /**
   * Ands this matcher factory with the passed matcher.
   */
  def and[U <: SC](rightMatcher: Matcher[U]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
   ...
   */
  def or[U <: SC](rightMatcher: Matcher[U]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
    new MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def and[U <: SC](rightMatcherFactory: MatcherFactory1[U, TC7]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
    new MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def or[U <: SC](rightMatcherFactory: MatcherFactory1[U, TC7]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
    new MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def and[U <: SC, TC8[_]](rightMatcherFactory: MatcherFactory1[U, TC8]): MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] =
   ...
   */
  def or[U <: SC, TC8[_]](rightMatcherFactory: MatcherFactory1[U, TC8]): MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] =
    new MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7 : TC8]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC8[_], TC9[_]](rightMatcherFactory: MatcherFactory2[U, TC8, TC9]): MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC8[_], TC9[_]](rightMatcherFactory: MatcherFactory2[U, TC8, TC9]): MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] =
    new MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7 : TC8 : TC9]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
  ...
  final class AndHaveWord {
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>:
     *
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Length] = and(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Size] = and(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Messaging] = and(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class AndContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Containing] = thisMatcherFactory.and(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, KeyMapping] = thisMatcherFactory.and(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, ValueMapping] = thisMatcherFactory.and(MatcherWords.contain.value(expectedValue))
     ...
     * </pre>
     */
    def theSameElementsAs(right: GenTraversable[_]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] = 
     ...
     * </pre>
     */
    def theSameElementsInOrderAs(right: GenTraversable[_]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Sequencing] = 
     ...
     * </pre>
     */
    def inOrderOnly(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Sequencing] =
     ...
     * </pre>
     */
    def allOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] =
     ...
     * </pre>
     */
    def allElementsOf(elements: GenTraversable[Any]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] =
     ...
     * </pre>
     */
    def inOrder(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Sequencing] =
     ...
     * </pre>
     */
    def inOrderElementsOf(elements: GenTraversable[Any]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Sequencing] =
     ...
     * </pre>
     */
    def oneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Containing] =
     ...
     * </pre>
     */
    def oneElementOf(elements: GenTraversable[Any]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Containing] =
     ...
     * </pre>
     */
    def atLeastOneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] =
     ...
     * </pre>
     */
    def atLeastOneElementOf(elements: GenTraversable[Any]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] =
     ...
     * </pre>
     */
    def only(right: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] = 
     ...
     * </pre>
     */
    def noneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Containing] =
     ...
     * </pre>
     */
    def noElementsOf(elements: GenTraversable[Any]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Containing] =
     ...
     * </pre>
     */
    def atMostOneOf(firstEle: Any, secondEle: Any, remainingEles: Any*): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] =
     ...
     * </pre>
     */
    def atMostOneElementOf(elements: GenTraversable[Any]): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Aggregating] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>file</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory7[SC with AnyRef with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.be.a(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>validNumber</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.be.a(aMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>apple</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory7[SC with AnyRef with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>integerNumber</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.be.definedAt(right))
  }
  ...
  final class AndFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class AndIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.include.regex(regex))
  }
  ...
  final class AndStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.startWith.regex(regex))
  }
  ...
  final class AndEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = and(MatcherWords.endWith.regex(regex))
  }
  ...
  final class AndNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def have[U](firstPropertyMatcher: HavePropertyMatcher[U, _], propertyMatchers: HavePropertyMatcher[U, _]*): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def be[U](resultOfLessThanComparison: ResultOfLessThanComparison[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(o))
     ...
     * </pre>
     */
    def be[U](resultOfGreaterThanComparison: ResultOfGreaterThanComparison[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def be[U](resultOfLessThanOrEqualToComparison: ResultOfLessThanOrEqualToComparison[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def be[U](resultOfGreaterThanOrEqualToComparison: ResultOfGreaterThanOrEqualToComparison[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>odd</code> is a <a href="BeMatcher.html"><code>BeMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(beMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>directory</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory7[SC with AnyRef with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(bePropertyMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>validMarks</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>invalidMarks</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = macro MatcherFactory7.andNotATypeMatcherFactory7[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = macro MatcherFactory7.andNotAnTypeMatcherFactory7[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.and(MatcherWords.not.be(spread))
     ...
     * </pre>
     */
    def be[A, U <: PartialFunction[A, _]](resultOfDefinedAt: ResultOfDefinedAt[A]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = 
     ...
     * </pre>
     */
    def fullyMatch(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def include(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def include(expectedSubstring: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def startWith(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def startWith(expectedSubstring: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def endWith(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
     ...
     * </pre>
     */
    def endWith(expectedSubstring: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
   ...
   * </pre>
   */
  def and(existWord: ExistWord): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Existence] = 
   ...
   * </pre>
   */
  def and(notExist: ResultOfNotExist): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Existence] = 
  ...
  final class OrHaveWord {
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Length] = or(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Size] = or(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Messaging] = or(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class OrContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Containing] = thisMatcherFactory.or(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, KeyMapping] = thisMatcherFactory.or(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, ValueMapping] = thisMatcherFactory.or(MatcherWords.contain.value(expectedValue))
...
()
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory7[SC with AnyRef with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.be.a(bePropertyMatcher))
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.be.a(aMatcher))
...
()
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory7[SC with AnyRef with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>integerNumber</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.be.definedAt(right))
  }
  ...
  final class OrFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class OrIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.include.regex(regex))
  }
  ...
  final class OrStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.startWith.regex(regex))
  }
  ...
  final class OrEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory7[SC with String, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = or(MatcherWords.endWith.regex(regex))
  }
  ...
  final class OrNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(o))
...
()
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(beMatcher))
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory7[SC with AnyRef with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(bePropertyMatcher))
...
()
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
...
()
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAnWordApplication: ResultOfAnWordToBePropertyMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))

    /**
     * This method enables the following syntax given a <code>MatcherFactory7</code>, where <code>invalidMarks</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     * aMatcherFactory and not be an (invalidMarks)
     *                         ^
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = macro MatcherFactory7.orNotATypeMatcherFactory7[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = macro MatcherFactory7.orNotAnTypeMatcherFactory7[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory7[SC with U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] = thisMatcherFactory.or(MatcherWords.not.be(spread))
   ...
   * </pre>
   */
  def or(existWord: ExistWord): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Existence] = 
   ...
   * </pre>
   */
  def or(notExist: ResultOfNotExist): MatcherFactory8[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7, Existence] = 
    thisMatcherFactory.or(MatcherWords.not.exist)
}

/**
 * Companion object containing an implicit method that converts a <code>MatcherFactory7</code> to a <code>Matcher</code>.
 *
 * @author Bill Venners
 */
object MatcherFactory7 {
  ...
  /**
   * Converts a <code>MatcherFactory7</code> to a <code>Matcher</code>.
   *
   * @param matcherFactory a MatcherFactory7 to convert
   * @return a Matcher produced by the passed MatcherFactory7
   */
  implicit def produceMatcher[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_], T <: SC : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7](matcherFactory: MatcherFactory7[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7]): Matcher[T] =
   ...
   */
  def andNotATypeMatcherFactory7[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] =
    new MatcherFactory7Macro[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7].andNotATypeMatcherFactory7(context)(aType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotATypeMatcherFactory7[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] =
    new MatcherFactory7Macro[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7].orNotATypeMatcherFactory7(context)(aType)

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory7[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] =
    new MatcherFactory7Macro[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7].andNotAnTypeMatcherFactory7(context)(anType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory7[SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] =
    new MatcherFactory7Macro[SC, TC1, TC2, TC3, TC4, TC5, TC6, TC7].orNotAnTypeMatcherFactory7(context)(anType)
}

private[scalatest] class MatcherFactory7Macro[-SC, TC1[_], TC2[_], TC3[_], TC4[_], TC5[_], TC6[_], TC7[_]] {

  import scala.reflect.macros.Context

  def andNotATypeMatcherFactory7(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] = {
  ...
  def orNotATypeMatcherFactory7(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] = {
    import context.universe._
  ...
  def andNotAnTypeMatcherFactory7(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] = {
    import context.universe._
  ...
  def orNotAnTypeMatcherFactory7(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory7[SC with AnyRef, TC1, TC2, TC3, TC4, TC5, TC6, TC7]] = {
    import context.universe._
