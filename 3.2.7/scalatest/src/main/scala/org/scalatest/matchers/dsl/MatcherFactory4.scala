...
abstract class MatcherFactory4[-SC, TC1[_], TC2[_], TC3[_], TC4[_]] { thisMatcherFactory =>
   ...
   * implicit parameter (for example, a <code>TC1[T]</code>, <code>TC2[T]</code>, <em>etc.</em>).
   */
  def matcher[T <: SC : TC1 : TC2 : TC3 : TC4]: Matcher[T]

  /**
   * Ands this matcher factory with the passed matcher.
   */
  def and[U <: SC](rightMatcher: Matcher[U]): MatcherFactory4[U, TC1, TC2, TC3, TC4] =
   ...
   */
  def or[U <: SC](rightMatcher: Matcher[U]): MatcherFactory4[U, TC1, TC2, TC3, TC4] =
    new MatcherFactory4[U, TC1, TC2, TC3, TC4] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def and[U <: SC](rightMatcherFactory: MatcherFactory1[U, TC4]): MatcherFactory4[U, TC1, TC2, TC3, TC4] =
    new MatcherFactory4[U, TC1, TC2, TC3, TC4] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def or[U <: SC](rightMatcherFactory: MatcherFactory1[U, TC4]): MatcherFactory4[U, TC1, TC2, TC3, TC4] =
    new MatcherFactory4[U, TC1, TC2, TC3, TC4] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   */
  def and[U <: SC, TC5[_]](rightMatcherFactory: MatcherFactory1[U, TC5]): MatcherFactory5[U, TC1, TC2, TC3, TC4, TC5] =
   ...
   */
  def or[U <: SC, TC5[_]](rightMatcherFactory: MatcherFactory1[U, TC5]): MatcherFactory5[U, TC1, TC2, TC3, TC4, TC5] =
    new MatcherFactory5[U, TC1, TC2, TC3, TC4, TC5] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC5[_], TC6[_]](rightMatcherFactory: MatcherFactory2[U, TC5, TC6]): MatcherFactory6[U, TC1, TC2, TC3, TC4, TC5, TC6] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC5[_], TC6[_]](rightMatcherFactory: MatcherFactory2[U, TC5, TC6]): MatcherFactory6[U, TC1, TC2, TC3, TC4, TC5, TC6] =
    new MatcherFactory6[U, TC1, TC2, TC3, TC4, TC5, TC6] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC5[_], TC6[_], TC7[_]](rightMatcherFactory: MatcherFactory3[U, TC5, TC6, TC7]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC5[_], TC6[_], TC7[_]](rightMatcherFactory: MatcherFactory3[U, TC5, TC6, TC7]): MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] =
    new MatcherFactory7[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC5[_], TC6[_], TC7[_], TC8[_]](rightMatcherFactory: MatcherFactory4[U, TC5, TC6, TC7, TC8]): MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC5[_], TC6[_], TC7[_], TC8[_]](rightMatcherFactory: MatcherFactory4[U, TC5, TC6, TC7, TC8]): MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] =
    new MatcherFactory8[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7 : TC8]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
   ...
   * Ands this matcher factory with the passed matcher factory.
   */
  def and[U <: SC, TC5[_], TC6[_], TC7[_], TC8[_], TC9[_]](rightMatcherFactory: MatcherFactory5[U, TC5, TC6, TC7, TC8, TC9]): MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] =
   ...
   * Ors this matcher factory with the passed matcher factory.
   */
  def or[U <: SC, TC5[_], TC6[_], TC7[_], TC8[_], TC9[_]](rightMatcherFactory: MatcherFactory5[U, TC5, TC6, TC7, TC8, TC9]): MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] =
    new MatcherFactory9[U, TC1, TC2, TC3, TC4, TC5, TC6, TC7, TC8, TC9] {
      def matcher[V <: U : TC1 : TC2 : TC3 : TC4 : TC5 : TC6 : TC7 : TC8 : TC9]: Matcher[V] = {
        new Matcher[V] {
          def apply(left: V): MatchResult = {
  ...
  final class AndHaveWord {
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>:
     *
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Length] = and(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Size] = and(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Messaging] = and(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class AndContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] = thisMatcherFactory.and(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, KeyMapping] = thisMatcherFactory.and(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, ValueMapping] = thisMatcherFactory.and(MatcherWords.contain.value(expectedValue))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>file</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory4[SC with AnyRef with U, TC1, TC2, TC3, TC4] = and(MatcherWords.be.a(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>validNumber</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = and(MatcherWords.be.a(aMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>apple</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory4[SC with AnyRef with U, TC1, TC2, TC3, TC4] = and(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>integerNumber</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = and(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = and(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = and(MatcherWords.be.definedAt(right))
  }
  ...
  final class AndFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class AndIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.include.regex(regex))
  }
  ...
  final class AndStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.startWith.regex(regex))
  }
  ...
  final class AndEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = and(MatcherWords.endWith.regex(regex))
  }
  ...
  final class AndNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal(any: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Equality] =
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def equal(o: Null): MatcherFactory4[SC, TC1, TC2, TC3, TC4] = {
     ...
     * </pre>
     */
    def be(any: Any): MatcherFactory4[SC, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def have(resultOfLengthWordApplication: ResultOfLengthWordApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Length] =
     ...
     * </pre>
     */
    def have(resultOfSizeWordApplication: ResultOfSizeWordApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Size] =
     ...
     * </pre>
     */
    def have(resultOfMessageWordApplication: ResultOfMessageWordApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Messaging] =
     ...
     * </pre>
     */
    def have[U](firstPropertyMatcher: HavePropertyMatcher[U, _], propertyMatchers: HavePropertyMatcher[U, _]*): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def be[U](resultOfLessThanComparison: ResultOfLessThanComparison[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(o))
     ...
     * </pre>
     */
    def be[U](resultOfGreaterThanComparison: ResultOfGreaterThanComparison[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def be[U](resultOfLessThanOrEqualToComparison: ResultOfLessThanOrEqualToComparison[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def be[U](resultOfGreaterThanOrEqualToComparison: ResultOfGreaterThanOrEqualToComparison[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] =
     ...
     * </p>
     */
    def be(tripleEqualsInvocation: TripleEqualsInvocation[_]): MatcherFactory4[SC, TC1, TC2, TC3, TC4] =
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>odd</code> is a <a href="BeMatcher.html"><code>BeMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(beMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>directory</code> is a <a href="BePropertyMatcher.html"><code>BePropertyMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory4[SC with AnyRef with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(bePropertyMatcher))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>validMarks</code> is an <a href="AMatcher.html"><code>AMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
...
()
    ...
    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>invalidMarks</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = macro MatcherFactory4.andNotATypeMatcherFactory4[SC, TC1, TC2, TC3, TC4]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = macro MatcherFactory4.andNotAnTypeMatcherFactory4[SC, TC1, TC2, TC3, TC4]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.and(MatcherWords.not.be(spread))
     ...
     * </pre>
     */
    def be[A, U <: PartialFunction[A, _]](resultOfDefinedAt: ResultOfDefinedAt[A]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = 
     ...
     * </pre>
     */
    def fullyMatch(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def include(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def include(expectedSubstring: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def startWith(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def startWith(expectedSubstring: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def endWith(resultOfRegexWordApplication: ResultOfRegexWordApplication): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def endWith(expectedSubstring: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] =
     ...
     * </pre>
     */
    def contain[U](expectedElement: U): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] =
     ...
     * </pre>
     */
    def contain(resultOfKeyWordApplication: ResultOfKeyWordApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, KeyMapping] =
     ...
     * </pre>
     */
    def contain(resultOfValueWordApplication: ResultOfValueWordApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, ValueMapping] =
     ...
     * </pre>
     */
    def contain(right: ResultOfOneOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] =
     ...
     * </pre>
     */
    def contain(right: ResultOfOneElementOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtLeastOneOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtLeastOneElementOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfNoneOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfNoElementsOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfTheSameElementsAsApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfTheSameElementsInOrderAsApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfOnlyApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderOnlyApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAllOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAllElementsOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfInOrderElementsOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Sequencing] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtMostOneOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain(right: ResultOfAtMostOneElementOfApplication): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Aggregating] =
      thisMatcherFactory.and(MatcherWords.not.contain(right))
   ...
   * </pre>
   */
  def and(existWord: ExistWord): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Existence] = 
   ...
   * </pre>
   */
  def and(notExist: ResultOfNotExist): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Existence] = 
  ...
  final class OrHaveWord {
     ...
     * </pre>
     */
    def length(expectedLength: Long): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Length] = or(MatcherWords.have.length(expectedLength))
     ...
     * </pre>
     */
    def size(expectedSize: Long): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Size] = or(MatcherWords.have.size(expectedSize))
     ...
     * </pre>
     */
    def message(expectedMessage: String): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Messaging] = or(MatcherWords.have.message(expectedMessage))
  }
  ...
  final class OrContainWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def apply(expectedElement: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Containing] = thisMatcherFactory.or(MatcherWords.contain(expectedElement))
     ...
     * </pre>
     */
    def key(expectedKey: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, KeyMapping] = thisMatcherFactory.or(MatcherWords.contain.key(expectedKey))
     ...
     * </pre>
     */
    def value(expectedValue: Any): MatcherFactory5[SC, TC1, TC2, TC3, TC4, ValueMapping] = thisMatcherFactory.or(MatcherWords.contain.value(expectedValue))
...
()
     ...
     * </pre>
     */
    def a[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory4[SC with AnyRef with U, TC1, TC2, TC3, TC4] = or(MatcherWords.be.a(bePropertyMatcher))
     ...
     * </pre>
     */
    def a[U](aMatcher: AMatcher[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = or(MatcherWords.be.a(aMatcher))
...
()
     ...
     * </pre>
     */
    def an[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory4[SC with AnyRef with U, TC1, TC2, TC3, TC4] = or(MatcherWords.be.an(bePropertyMatcher))

    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>integerNumber</code> is a <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     ...
     * </pre>
     */
    def an[U](anMatcher: AnMatcher[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = or(MatcherWords.be.an(anMatcher))
     ...
     * </pre>
     */
    def theSameInstanceAs(anyRef: AnyRef): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = or(MatcherWords.be.theSameInstanceAs(anyRef))
     ...
     * </pre>
     */
    def definedAt[A, U <: PartialFunction[A, _]](right: A): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = or(MatcherWords.be.definedAt(right))
  }
  ...
  final class OrFullyMatchWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.fullyMatch.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.fullyMatch.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.fullyMatch.regex(regex))
  }
  ...
  final class OrIncludeWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.include.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.include.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.include.regex(regex))
  }
  ...
  final class OrStartWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.startWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.startWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.startWith.regex(regex))
  }
  ...
  final class OrEndWithWord {
     ...
     * </pre>
     */
    def regex(regexString: String): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.endWith.regex(regexString))
     ...
     * </pre>
     */
    def regex(regexWithGroups: RegexWithGroups): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.endWith.regex(regexWithGroups))
     ...
     * </pre>
     */
    def regex(regex: Regex): MatcherFactory4[SC with String, TC1, TC2, TC3, TC4] = or(MatcherWords.endWith.regex(regex))
  }
  ...
  final class OrNotWord(prettifier: Prettifier, pos: source.Position) {
     ...
     * </pre>
     */
    def equal[U](spread: Spread[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.equal(spread))
     ...
     * </pre>
     */
    def be(o: Null): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(o))
...
()
     ...
     * </pre>
     */
    def be[U](beMatcher: BeMatcher[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(beMatcher))
     ...
     * </pre>
     */
    def be[U](bePropertyMatcher: BePropertyMatcher[U]): MatcherFactory4[SC with AnyRef with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(bePropertyMatcher))
...
()
     ...
     * </pre>
     */
    def be[U](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAWordApplication: ResultOfAWordToBePropertyMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
...
()
     ...
     * </pre>
     */
    def be[U <: AnyRef](resultOfAnWordApplication: ResultOfAnWordToBePropertyMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))

    /**
     * This method enables the following syntax given a <code>MatcherFactory4</code>, where <code>invalidMarks</code> is an <a href="AnMatcher.html"><code>AnMatcher</code></a>:
     *
     * <pre class="stHighlighted">
     * aMatcherFactory and not be an (invalidMarks)
     *                         ^
     * </pre>
     */
    def be[U](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = macro MatcherFactory4.orNotATypeMatcherFactory4[SC, TC1, TC2, TC3, TC4]
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = macro MatcherFactory4.orNotAnTypeMatcherFactory4[SC, TC1, TC2, TC3, TC4]
     ...
     * </pre>
     */
    def be(resultOfTheSameInstanceAsApplication: ResultOfTheSameInstanceAsApplication): MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(resultOfTheSameInstanceAsApplication))
     ...
     * </pre>
     */
    def be[U](spread: Spread[U]): MatcherFactory4[SC with U, TC1, TC2, TC3, TC4] = thisMatcherFactory.or(MatcherWords.not.be(spread))
   ...
   * </pre>
   */
  def or(existWord: ExistWord): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Existence] = 
   ...
   * </pre>
   */
  def or(notExist: ResultOfNotExist): MatcherFactory5[SC, TC1, TC2, TC3, TC4, Existence] = 
    thisMatcherFactory.or(MatcherWords.not.exist)
}

/**
 * Companion object containing an implicit method that converts a <code>MatcherFactory4</code> to a <code>Matcher</code>.
 *
 * @author Bill Venners
 */
object MatcherFactory4 {

  import scala.language.implicitConversions

  /**
   * Converts a <code>MatcherFactory4</code> to a <code>Matcher</code>.
   *
   * @param matcherFactory a MatcherFactory4 to convert
   * @return a Matcher produced by the passed MatcherFactory4
   */
  implicit def produceMatcher[SC, TC1[_], TC2[_], TC3[_], TC4[_], T <: SC : TC1 : TC2 : TC3 : TC4](matcherFactory: MatcherFactory4[SC, TC1, TC2, TC3, TC4]): Matcher[T] =
   ...
   */
  def andNotATypeMatcherFactory4[SC, TC1[_], TC2[_], TC3[_], TC4[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] =
    new MatcherFactory4Macro[SC, TC1, TC2, TC3, TC4].andNotATypeMatcherFactory4(context)(aType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotATypeMatcherFactory4[SC, TC1[_], TC2[_], TC3[_], TC4[_]](context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] =
    new MatcherFactory4Macro[SC, TC1, TC2, TC3, TC4].orNotATypeMatcherFactory4(context)(aType)

  /**
   * This method is called by macro that supports 'and not a [Type]' syntax.
   */
  def andNotAnTypeMatcherFactory4[SC, TC1[_], TC2[_], TC3[_], TC4[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] =
    new MatcherFactory4Macro[SC, TC1, TC2, TC3, TC4].andNotAnTypeMatcherFactory4(context)(anType)

  /**
   * This method is called by macro that supports 'or not a [Type]' syntax.
   */
  def orNotAnTypeMatcherFactory4[SC, TC1[_], TC2[_], TC3[_], TC4[_]](context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] =
    new MatcherFactory4Macro[SC, TC1, TC2, TC3, TC4].orNotAnTypeMatcherFactory4(context)(anType)
}

private[scalatest] class MatcherFactory4Macro[-SC, TC1[_], TC2[_], TC3[_], TC4[_]] {

  import scala.reflect.macros.Context

  def andNotATypeMatcherFactory4(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] = {
  ...
  def orNotATypeMatcherFactory4(context: Context)(aType: context.Expr[ResultOfATypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] = {
    import context.universe._
  ...
  def andNotAnTypeMatcherFactory4(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] = {
    import context.universe._
  ...
  def orNotAnTypeMatcherFactory4(context: Context)(anType: context.Expr[ResultOfAnTypeInvocation[_]]): context.Expr[MatcherFactory4[SC with AnyRef, TC1, TC2, TC3, TC4]] = {
    import context.universe._
