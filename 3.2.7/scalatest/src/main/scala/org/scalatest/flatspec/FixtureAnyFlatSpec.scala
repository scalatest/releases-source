 ...
 * 
 * <p>
 * Class <code>FixtureAnyFlatSpec</code> behaves similarly to class <code>org.scalatest.flatspec.AnyFlatSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.flatspec.AnyFlatSpec</code>:
 * </p>
 * 
 * <ol>
...
abstract class FixtureAnyFlatSpec extends org.scalatest.flatspec.FixtureAnyFlatSpecLike {
