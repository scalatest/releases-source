...
/**
 * A sister class to <code>org.scalatest.featurespec.AnyFeatureSpec</code> that can pass a fixture object into its tests.
 *
 * <table><tr><td class="usage">
 * <strong>Recommended Usage</strong>:
 * Use class <code>FixtureAnyFeatureSpec</code> in situations for which <a href="AnyFeatureSpec.html"><code>AnyFeatureSpec</code></a>
 * would be a good choice, when all or most tests need the same fixture objects
 * that must be cleaned up afterwards. <em>Note: <code>FixtureAnyFeatureSpec</code> is intended for use in special situations, with class <code>AnyFeatureSpec</code> used for general needs. For
 * more insight into where <code>FixtureAnyFeatureSpec</code> fits in the big picture, see the <a href="AnyFeatureSpec.html#withFixtureOneArgTest"><code>withFixture(OneArgTest)</code></a> subsection of the <a href="AnyFeatureSpec.html#sharedFixtures">Shared fixtures</a> section in the documentation for class <code>AnyFeatureSpec</code>.</em>
 * </td></tr></table>
 * 
 * <p>
 * Class <code>FixtureAnyFeatureSpec</code> behaves similarly to class <code>org.scalatest.featurespec.AnyFeatureSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>org.scalatest.featurespec.AnyFeatureSpec</code>:
 * </p>
 * 
 * <ol>
 ...
 *   }
 * }
 * <br/><span class="stReserved">class</span> <span class="stType">ExampleSpec</span> <span class="stReserved">extends</span> <span class="stType">featurespec.FixtureAnyFeatureSpec</span> <span class="stReserved">with</span> <span class="stType">DbFixture</span> {
 ...
 *   }
 * <br/>  <span class="stType">Feature</span>(<span class="stQuotedString">"Simplicity"</span>) {
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to read test code written by others"</span>) { db =&gt;
 ...
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to understand what the tests are doing"</span>) { db =&gt;
 ...
 *     }
 * <br/>    <span class="stType">Scenario</span>(<span class="stQuotedString">"User needs to write tests"</span>) { () =&gt;
