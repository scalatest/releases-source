...
final class NonEmptyVector[+T] private (val toVector: Vector[T]) extends AnyVal {
  ...
  */
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * <span class="stType">NonEmptyVector</span>(<span class="stQuotedString">'a'</span>, <span class="stQuotedString">'b'</span>, <span class="stQuotedString">'b'</span>).permutations.toVector = <span class="stType">Vector</span>(<span class="stType">NonEmptyVector</span>(a, b, b), <span class="stType">NonEmptyVector</span>(b, a, b), <span class="stType">NonEmptyVector</span>(b, b, a))
    * </pre>
    *
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * <span class="stType">NonEmptyVector</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scan(<span class="stLiteral">0</span>)(_ + _) == <span class="stType">NonEmptyVector</span>(<span class="stLiteral">0</span>, <span class="stLiteral">1</span>, <span class="stLiteral">3</span>, <span class="stLiteral">6</span>)
    * <span class="stType">NonEmptyVector</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scan(<span class="stQuotedString">"z"</span>)(_ + _.toString) == <span class="stType">NonEmptyVector</span>(<span class="stQuotedString">"z"</span>, <span class="stQuotedString">"z1"</span>, <span class="stQuotedString">"z12"</span>, <span class="stQuotedString">"z123"</span>)
    * </pre>
    *
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * <span class="stType">NonEmptyVector</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanLeft(<span class="stLiteral">0</span>)(_ + _) == <span class="stType">NonEmptyVector</span>(<span class="stLiteral">0</span>, <span class="stLiteral">1</span>, <span class="stLiteral">3</span>, <span class="stLiteral">6</span>)
    * <span class="stType">NonEmptyVector</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanLeft(<span class="stQuotedString">"z"</span>)(_ + _) == <span class="stType">NonEmptyVector</span>(<span class="stQuotedString">"z"</span>, <span class="stQuotedString">"z1"</span>, <span class="stQuotedString">"z12"</span>, <span class="stQuotedString">"z123"</span>)
    * </pre>
    *
  ...
  /**
    ...
    *
    * <pre class="stHighlighted">
    * <span class="stType">NonEmptyVector</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanRight(<span class="stLiteral">0</span>)(_ + _) == <span class="stType">NonEmptyVector</span>(<span class="stLiteral">6</span>, <span class="stLiteral">5</span>, <span class="stLiteral">3</span>, <span class="stLiteral">0</span>)
    * <span class="stType">NonEmptyVector</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanRight(<span class="stQuotedString">"z"</span>)(_ + _) == <span class="stType">NonEmptyVector</span>(<span class="stQuotedString">"123z"</span>, <span class="stQuotedString">"23z"</span>, <span class="stQuotedString">"3z"</span>, <span class="stQuotedString">"z"</span>)
    * </pre>
    *
