...
/**
 * An <code>AnyVal</code> for non-zero <code>Long</code>s.
 *
 * Note: a <code>NonZeroLong</code> may not equal 0.
 *
 * <p>
 * Because <code>NonZeroLong</code> is an <code>AnyVal</code> it
 * will usually be as efficient as an <code>Long</code>, being
 * boxed only when an <code>Long</code> would have been boxed.
 * </p>
 *
 * <p>
 * The <code>NonZeroLong.apply</code> factory method is implemented
 ...
 *
 * <p>
 * <code>NonZeroLong.apply</code> cannot be used if the value being
 ...
 * <code>NonZeroLong.from</code>, instead:
 * </p>
 *
 * <pre class="stREPL">
 * scala&gt; val x = 42L
 ...
 *
 * <p>
 * The <code>NonZeroLong.from</code> factory method will inspect the
 ...
 *
 * <p>
 * The <code>NonZeroLong.apply</code> factory method is marked
 ...
 * <code>NonZeroLong.apply</code> explicitly. Here's an example:
 * </p>
 *
 * <pre class="stREPL">
 ...
 *
 * <p>
 * This example also demonstrates that the <code>NonZeroLong</code>
 ...
 * </p>
 *
 * @param value The <code>Long</code> value underlying this <code>NonZeroLong</code>.
 */
final class NonZeroLong private (val value: Long) extends AnyVal {

  /**
   * A string representation of this <code>NonZeroLong</code>.
   */
  override def toString: String = s"NonZeroLong(${value}L)"

  /**
   * Converts this <code>NonZeroLong</code> to a <code>Byte</code>.
   */
  def toByte: Byte = value.toByte

  /**
   * Converts this <code>NonZeroLong</code> to a <code>Short</code>.
   */
  def toShort: Short = value.toShort

  /**
   * Converts this <code>NonZeroLong</code> to a <code>Char</code>.
   */
  def toChar: Char = value.toChar

  /**
   * Converts this <code>NonZeroLong</code> to an <code>Int</code>.
   */
  def toInt: Int = value.toInt

  /**
   * Converts this <code>NonZeroLong</code> to a <code>Long</code>.
   */
  def toLong: Long = value.toLong

  /**
   * Converts this <code>NonZeroLong</code> to a <code>Float</code>.
   */
  def toFloat: Float = value.toFloat

  /**
   * Converts this <code>NonZeroLong</code> to a <code>Double</code>.
   */
  ...
  */
  ...
  def unary_+ : NonZeroLong = this
  /** Returns the negation of this value. */
  def unary_- : NonZeroLong = NonZeroLong.ensuringValid(-value)

  /**
   * Converts this <code>NonZeroLong</code>'s value to a string then concatenates the given string.
   */
  ...
  // Stuff from RichLong:
  /**
   * Returns a string representation of this <code>NonZeroLong</code>'s underlying <code>Long</code>
   * as an unsigned integer in base&nbsp;2.
   *
   * <p>
   * The unsigned <code>long</code> value is this <code>NonZeroLong</code>'s underlying <code>Long</code> plus
   ...
   *          value represented by this <code>NonZeroLong</code>'s underlying <code>Long</code> in binary (base&nbsp;2).
   */
   ...
   *
   * @return  the string representation of the unsigned <code>long</code>
   *          value represented by this <code>NonZeroLong</code>'s underlying <code>Long</code> in hexadecimal
   *          (base&nbsp;16).
   */
   ...
   *
   * @return  the string representation of the unsigned <code>long</code>
   *          value represented by this <code>NonZeroLong</code>'s underlying <code>Long</code> in octal (base&nbsp;8).
   */
   ...
   */
  def max(that: NonZeroLong): NonZeroLong = if (math.max(value, that.value) == value) this else that

  /**
   * Returns <code>this</code> if <code>this &lt; that</code> or <code>that</code> otherwise.
   */
  def min(that: NonZeroLong): NonZeroLong = if (math.min(value, that.value) == value) this else that

  // adapted from RichInt:
  /**
   * Create a <code>Range</code> from this <code>NonZeroLong</code> value
  ...
  /**
   * Create an inclusive <code>Range</code> from this <code>NonZeroLong</code> value
   ...
   * value, and if the result is positive, returns the result wrapped in a <code>NonZeroLong</code>,
   * else throws <code>AssertionError</code>.
   *
   * <p>
   * This method will inspect the result of applying the given function to this
   * <code>NonZeroLong</code>'s underlying <code>Long</code> value and if the result
   * is non-zero, it will return a <code>NonZeroLong</code> representing that value.
   * Otherwise, the <code>Long</code> value returned by the given function is
   * not non-zero, this method will throw <code>AssertionError</code>.
   * </p>
   *
   * <p>
   * This method differs from a vanilla <code>assert</code> or <code>ensuring</code>
   * call in that you get something you didn't already have if the assertion
   * succeeds: a <em>type</em> that promises an <code>Long</code> is non-zero.
   * With this method, you are asserting that you are convinced the result of
   * the computation represented by applying the given function to this <code>NonZeroLong</code>'s
   ...
   * </p>
   *
   * @param f the <code>Long =&gt; Long</code> function to apply to this <code>NonZeroLong</code>'s
   *     underlying <code>Long</code> value.
   * @return the result of applying this <code>NonZeroLong</code>'s underlying <code>Long</code> value to
   *     to the passed function, wrapped in a <code>NonZeroLong</code> if it is non-zero (else throws <code>AssertionError</code>).
   * @throws AssertionError if the result of applying this <code>NonZeroLong</code>'s underlying <code>Long</code> value to
   *     to the passed function is not positive.
   */
  def ensuringValid(f: Long => Long): NonZeroLong = {
    val candidateResult: Long = f(value)
    if (NonZeroLongMacro.isValid(candidateResult)) new NonZeroLong(candidateResult)
    else throw new AssertionError(s"${candidateResult.toString()}, the result of applying the passed function to ${value.toString()}, was not a valid NonZeroLong")
  }
}

/**
 * The companion object for <code>NonZeroLong</code> that offers
...
object NonZeroLong {
   ...
   * <code>Long</code>, which is <code>NonZeroLong(9223372036854775807)</code>.
   */
  final val MaxValue: NonZeroLong = NonZeroLong.ensuringValid(Long.MaxValue)

  /**
   * The smallest value representable as a positive
   * <code>Long</code>, which is <code>NonZeroLong(-9223372036854775808)</code>.
   */
  final val MinValue: NonZeroLong = NonZeroLong.ensuringValid(Long.MinValue) // Can't use the macro here

  /**
   * A factory method that produces an <code>Option[NonZeroLong]</code> given a
   ...
   * </p>
   *
   * @param value the <code>Long</code> to inspect, and if non-zero, return
   *     wrapped in a <code>Some[NonZeroLong]</code>.
   * @return the specified <code>Long</code> value wrapped in a
   *     <code>Some[NonZeroLong]</code>, if it is non-zero, else
   *     <code>None</code>.
   */
  def from(value: Long): Option[NonZeroLong] =
    if (NonZeroLongMacro.isValid(value)) Some(new NonZeroLong(value)) else None

  /**
   * A factory/assertion method that produces an <code>NonZeroLong</code> given a
   ...
   *
   * @param value the <code>Long</code> to inspect, and if non-zero, return
   *     wrapped in a <code>NonZeroLong</code>.
   * @return the specified <code>Long</code> value wrapped in a
   ...
   */
  def ensuringValid(value: Long): NonZeroLong =
    if (NonZeroLongMacro.isValid(value)) new NonZeroLong(value) else {
      throw new AssertionError(s"${value.toString()}  was not a valid NonZeroLong")
    }

  /**
   * A factory/validation method that produces a <code>NonZeroLong</code>, wrapped
   ...
   *
   * @param value the <code>Long</code> to inspect, and if non-zero, return
   *     wrapped in a <code>Success(NonZeroLong)</code>.
   * @return the specified <code>Long</code> value wrapped
   *     in a <code>Success(NonZeroLong)</code>, if it is non-zero, else a <code>Failure(AssertionError)</code>.
   */
   def tryingValid(value: Long): Try[NonZeroLong] =
     if (NonZeroLongMacro.isValid(value))
       Success(new NonZeroLong(value))
     else
       Failure(new AssertionError(s"${value.toString()} was not a valid NonZeroLong"))
   ...
   * </p>
   *
   * @param value the `Long` to validate that it is non-zero.
   * @return a `Pass` if the specified `Long` value is non-zero,
   *   else a `Fail` containing an error value produced by passing the
   *   specified `Long` to the given function `f`.
   */
  def passOrElse[E](value: Long)(f: Long => E): Validation[E] =
    if (NonZeroLongMacro.isValid(value)) Pass else Fail(f(value))
   ...
   *
   * @param value the <code>Long</code> to inspect, and if non-zero, return
   *     wrapped in a <code>Good(NonZeroLong)</code>.
   * @return the specified <code>Long</code> value wrapped
   *     in a <code>Good(NonZeroLong)</code>, if it is non-zero, else a <code>Bad(f(value))</code>.
   */
  def goodOrElse[B](value: Long)(f: Long => B): NonZeroLong Or B =
    if (NonZeroLongMacro.isValid(value)) Good(NonZeroLong.ensuringValid(value)) else Bad(f(value))
   ...
   *     wrapped in a <code>Right(NonZeroLong)</code>.
   * @return the specified <code>Int</code> value wrapped
   *     in a <code>Right(NonZeroLong)</code>, if it is non-zero, else a <code>Left(f(value))</code>.
   */
  def rightOrElse[L](value: Long)(f: Long => L): Either[L, NonZeroLong] =
    if (NonZeroLongMacro.isValid(value)) Right(NonZeroLong.ensuringValid(value)) else Left(f(value))

  /**
   * A predicate method that returns true if a given
   * <code>Long</code> value is non-zero.
   *
   * @param value the <code>Long</code> to inspect, and if non-zero, return true.
   * @return true if the specified <code>Long</code> is non-zero, else false.
   */
  def isValid(value: Long): Boolean = NonZeroLongMacro.isValid(value)

  /**
   * A factory method that produces a <code>NonZeroLong</code> given a
   * <code>Long</code> value and a default <code>NonZeroLong</code>.
   *
   * <p>
   * This method will inspect the passed <code>Long</code> value and if
   * it is a non-zero <code>Long</code>, it will return a <code>NonZeroLong</code> representing that value.
   ...
   *
   * @param value the <code>Long</code> to inspect, and if non-zero, return.
   * @param default the <code>NonZeroLong</code> to return if the passed
   *     <code>Long</code> value is not non-zero.
   * @return the specified <code>Long</code> value wrapped in a
   *     <code>NonZeroLong</code>, if it is non-zero, else the
   *     <code>default</code> <code>NonZeroLong</code> value.
   */
  def fromOrElse(value: Long, default: => NonZeroLong): NonZeroLong =
    if (NonZeroLongMacro.isValid(value)) new NonZeroLong(value) else default
   ...
   *     wrapped in a <code>NonZeroLong</code> at run time.
   ...
   *     compile.)
   */
  implicit def apply(value: Long): NonZeroLong = macro NonZeroLongMacro.apply

  /**
   * Implicit widening conversion from <code>NonZeroLong</code> to
   * <code>Long</code>.
   *
   * @param pos the <code>NonZeroLong</code> to widen
   * @return the <code>Long</code> value underlying the specified
   *     <code>NonZeroLong</code>.
   */
  implicit def widenToLong(pos: NonZeroLong): Long = pos.value
   ...
   * @param pos the <code>NonZeroLong</code> to widen
   * @return the <code>Long</code> value underlying the specified
   *     <code>NonZeroLong</code>, widened to <code>Float</code>.
   */
  implicit def widenToFloat(pos: NonZeroLong): Float = pos.value
   ...
   * @param pos the <code>NonZeroLong</code> to widen
   * @return the <code>Long</code> value underlying the specified
   *     <code>NonZeroLong</code>, widened to <code>Double</code>.
   */
  implicit def widenToDouble(pos: NonZeroLong): Double = pos.value


  /**
   * Implicit widening conversion from <code>NonZeroLong</code> to <code>NonZeroFloat</code>.
   *
   * @param pos the <code>NonZeroLong</code> to widen
   * @return the <code>Long</code> value underlying the specified <code>NonZeroLong</code>,
   *     widened to <code>Float</code> and wrapped in a <code>NonZeroFloat</code>.
   */
  implicit def widenToNonZeroFloat(pos: NonZeroLong): NonZeroFloat = NonZeroFloat.ensuringValid(pos.value)

  /**
   * Implicit widening conversion from <code>NonZeroLong</code> to <code>NonZeroDouble</code>.
   *
   * @param pos the <code>NonZeroLong</code> to widen
   * @return the <code>Long</code> value underlying the specified <code>NonZeroLong</code>,
   *     widened to <code>Double</code> and wrapped in a <code>NonZeroDouble</code>.
   */
  implicit def widenToNonZeroDouble(pos: NonZeroLong): NonZeroDouble = NonZeroDouble.ensuringValid(pos.value)


  /**
   * Implicit Ordering instance.
   */
  implicit val ordering: Ordering[NonZeroLong] =
    new Ordering[NonZeroLong] {
      def compare(x: NonZeroLong, y: NonZeroLong): Int = x.toLong.compare(y)
    }
