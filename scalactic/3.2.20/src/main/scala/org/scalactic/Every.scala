 ...
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>)
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>)
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>)
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">One</span>(<span class="stLiteral">1</span>)
 * <span class="stType">Many</span>(<span class="stLiteral">1</span>, <span class="stLiteral">3</span>)
 * <span class="stType">Many</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>)
 * </pre>
 *
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">Many</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).map(_ + <span class="stLiteral">1</span>)                  <span class="stLineComment">// Result: Many(2, 3, 4)</span>
 * <span class="stType">One</span>(<span class="stLiteral">1</span>).map(_ + <span class="stLiteral">1</span>)                         <span class="stLineComment">// Result: One(2)</span>
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).containsSlice(<span class="stType">Every</span>(<span class="stLiteral">2</span>, <span class="stLiteral">3</span>)) <span class="stLineComment">// Result: true</span>
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).containsSlice(<span class="stType">Every</span>(<span class="stLiteral">3</span>, <span class="stLiteral">4</span>)) <span class="stLineComment">// Result: false</span>
 * <span class="stType">Every</span>(-<span class="stLiteral">1</span>, -<span class="stLiteral">2</span>, <span class="stLiteral">3</span>, <span class="stLiteral">4</span>, <span class="stLiteral">5</span>).minBy(_.abs)       <span class="stLineComment">// Result: -1</span>
 * </pre>
 *
 * <p>
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).filter(_ &lt; <span class="stLiteral">10</span>) <span class="stLineComment">// Result: Vector(1, 2, 3)</span>
 * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).filter(_ &gt; <span class="stLiteral">10</span>) <span class="stLineComment">// Result: Vector()</span>
 * </pre>
 *
 *
 * <p>
...
*/
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">Every</span>(<span class="stQuotedString">'a'</span>, <span class="stQuotedString">'b'</span>, <span class="stQuotedString">'b'</span>).permutations.toList = <span class="stType">Iterator</span>(<span class="stType">Many</span>(a, b, b), <span class="stType">Many</span>(b, a, b), <span class="stType">Many</span>(b, b, a))
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scan(<span class="stLiteral">0</span>)(_ + _) == <span class="stType">Every</span>(<span class="stLiteral">0</span>, <span class="stLiteral">1</span>, <span class="stLiteral">3</span>, <span class="stLiteral">6</span>)
   * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scan(<span class="stQuotedString">"z"</span>)(_ + _.toString) == <span class="stType">Every</span>(<span class="stQuotedString">"z"</span>, <span class="stQuotedString">"z1"</span>, <span class="stQuotedString">"z12"</span>, <span class="stQuotedString">"z123"</span>)
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanLeft(<span class="stLiteral">0</span>)(_ + _) == <span class="stType">Every</span>(<span class="stLiteral">0</span>, <span class="stLiteral">1</span>, <span class="stLiteral">3</span>, <span class="stLiteral">6</span>)
   * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanLeft(<span class="stQuotedString">"z"</span>)(_ + _) == <span class="stType">Every</span>(<span class="stQuotedString">"z"</span>, <span class="stQuotedString">"z1"</span>, <span class="stQuotedString">"z12"</span>, <span class="stQuotedString">"z123"</span>)
   * </pre>
   *
   ...
   *
   * <pre class="stHighlighted">
   * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanRight(<span class="stLiteral">0</span>)(_ + _) == <span class="stType">Every</span>(<span class="stLiteral">6</span>, <span class="stLiteral">5</span>, <span class="stLiteral">3</span>, <span class="stLiteral">0</span>)
   * <span class="stType">Every</span>(<span class="stLiteral">1</span>, <span class="stLiteral">2</span>, <span class="stLiteral">3</span>).scanRight(<span class="stQuotedString">"z"</span>)(_ + _) == <span class="stType">Every</span>(<span class="stQuotedString">"123z"</span>, <span class="stQuotedString">"23z"</span>, <span class="stQuotedString">"3z"</span>, <span class="stQuotedString">"z"</span>)
   * </pre>
   *
