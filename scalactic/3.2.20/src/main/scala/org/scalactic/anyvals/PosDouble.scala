...
final class PosDouble private (val value: Double) extends AnyVal {
  ...
  /**
   * True if this <code>PosDouble</code> value represents positive infinity, else false.
   */
  def isPosInfinity: Boolean = Double.PositiveInfinity == value

  /**
   * True if this <code>PosDouble</code> value is any finite value (i.e., it is neither positive nor negative infinity), else false.
   */
...
object PosDouble {
   ...
   * it is a positive <code>Double</code>, it will return a <code>PosDouble</code>
   ...
   *     <code>Some[PosDouble]</code>, if it is PosDouble, else
   *     <code>None</code>.
   */
   ...
   * This method will inspect the passed <code>Double</code> value and if
   * it is a positive <code>Double</code>, it will return a <code>PosDouble</code>
   * representing that value. Otherwise, the passed <code>Double</code> value is not positive,
   ...
   * it is a positive <code>Float</code>, it will return a <code>PosDouble</code>
   ...
   *     in a <code>Success(PosDouble)</code>, if it is positive, else a <code>Failure(AssertionError)</code>.
   */
   ...
   * <p>
   * This method will inspect the passed <code>Double</code> value and if
   * it is a positive <code>Double</code>, it will return a <code>Pass</code>.
   * Otherwise, the passed <code>Double</code> value is positive, so this
   ...
   * Otherwise, the passed <code>Double</code> value is not positive, so this
   ...
   *     in a <code>Good(PosDouble)</code>, if it is positive, else a <code>Bad(f(value))</code>.
   */
   ...
   * @return the specified <code>Double</code> value wrapped
   *     in a <code>Right(PosDouble)</code>, if it is positive, else a <code>Left(f(value))</code>.
   */
   ...
   * This method will inspect the passed <code>Double</code> value and if
   * it is a positive <code>Double</code>, it will return a <code>PosDouble</code>
   * representing that value.  Otherwise, the passed <code>Double</code> value is positive,
   ...
   * it will return a <code>PosDouble</code> representing that value.
  ...
  /**
   * Implicit widening conversion from <code>PosDouble</code> to <code>PosZDouble</code>.
   *
   * @param pos the <code>PosDouble</code> to widen
   * @return the <code>Double</code> value underlying the specified <code>PosDouble</code>,
  ...
  /**
   * Implicit widening conversion from <code>PosDouble</code> to <code>NonZeroDouble</code>.
   *
   * @param pos the <code>PosDouble</code> to widen
   * @return the <code>Double</code> value underlying the specified <code>PosDouble</code>,
  ...
  /**
   * The smallest positive value greater than 0.0d representable as a <code>PosDouble</code>, which is PosDouble(4.9E-324).
   */
  final val MinPositiveValue: PosDouble = PosDouble.ensuringValid(Double.MinPositiveValue)

  /**
   * <strong>The formerly implicit <code>posDoubleOrd</code> field has been deprecated and will be removed in a future version of ScalaTest. Please use the <code>ordering</code> field instead.</strong>
   */
