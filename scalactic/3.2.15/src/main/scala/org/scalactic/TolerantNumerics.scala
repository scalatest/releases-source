 ...
 * <span class="stReserved">class</span> <span class="stType">TolerantDoubleEquality</span> <span class="stReserved">extends</span> <span class="stType">Equality[Double]</span> {
 * <br/>  <span class="stReserved">private</span> <span class="stReserved">val</span> <span class="stType">Tol</span> = <span class="stLiteral">0.01</span>
 * <br/>  <span class="stReserved">def</span> areEqual(a: <span class="stType">Double</span>, b: <span class="stType">Any</span>): <span class="stType">Boolean</span> = {
 *     b <span class="stReserved">match</span> {
 *       <span class="stReserved">case</span> bDouble: <span class="stType">Double</span> =&gt; (a <= bDouble + <span class="stType">Tol</span>) && (a >= bDouble - <span class="stType">Tol</span>)
