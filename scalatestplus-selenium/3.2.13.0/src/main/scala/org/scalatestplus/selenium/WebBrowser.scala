    ...
    def value_=(value: String)(implicit driver: WebDriver): Unit = {
      ...
      driver match {
        case executor: JavascriptExecutor =>
          executor.executeScript("arguments[0].value = arguments[1];", underlying, value)
          if (underlying.getAttribute("value") != value)
            underlying.sendKeys(value)
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">trait</span> <span class="stType">MyBrowserTests</span> {
 *   <span class="stReserved">this</span>: <span class="stType">WebBrowser</span> <span class="stReserved">with</span> <span class="stType">Driver</span> =&gt;
 *   <span class="stLineComment">// Your browser tests</span>
 * }
 * </pre>
 *
 ...
 *
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">MyBrowserTestsWithChrome</span> <span class="stReserved">extends</span> <span class="stType">MyBrowserTests</span> <span class="stReserved">with</span> <span class="stType">Chrome</span>
 * <span class="stReserved">class</span> <span class="stType">MyBrowserTestsWithSafari</span> <span class="stReserved">extends</span> <span class="stType">MyBrowserTests</span> <span class="stReserved">with</span> <span class="stType">Safari</span>
 * <span class="stReserved">class</span> <span class="stType">MyBrowserTestsWithInternetExplorer</span> <span class="stReserved">extends</span> <span class="stType">MyBrowserTests</span> <span class="stReserved">with</span> <span class="stType">InternetExplorer</span>
 * <span class="stReserved">class</span> <span class="stType">MyBrowserTestsWithFirefox</span> <span class="stReserved">extends</span> <span class="stType">MyBrowserTests</span> <span class="stReserved">with</span> <span class="stType">Firefox</span>
 * </pre>
 */
 ...
 * 
 * <pre class="stHighlighted">
 * <span class="stReserved">class</span> <span class="stType">WebAppSpec</span> <span class="stReserved">extends</span> <span class="stType">Firefox</span> <span class="stReserved">with</span> <span class="stType">ScreenshotOnFailure</span> {
